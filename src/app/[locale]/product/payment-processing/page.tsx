          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-3">
              <div className="border border-neutral-200 bg-neutral-50 p-8 text-center">
                <div className="mx-auto flex h-16 w-16 items-center justify-center bg-rausch-500/10">
                  <HugeiconsIcon className="h-8 w-8 text-rausch-500" icon={CreditCardIcon} />
                </div>
              ...
              <div className="border border-neutral-200 bg-neutral-50 p-8 text-center">
                <div className="mx-auto flex h-16 w-16 items-center justify-center bg-rausch-500/10">
                  <HugeiconsIcon className="h-8 w-8 text-rausch-500" icon={Invoice01Icon} />
                </div>
                <h3 className="mt-6 font-semibold text-neutral-900 text-xl">
