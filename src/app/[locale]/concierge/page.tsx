          ...
          >
            <div className="rounded-2xl border border-neutral-200 bg-white p-12 shadow-sm">
              ...
              <p className="mb-8 text-lg text-neutral-600">
                Thank you for choosing Casaora Concierge. Our team will review your request and
                reach out within 2 hours during business hours (Mon-Fri, 9am-6pm COT).
              </p>

              <div className="mb-8 rounded-lg border border-blue-200 bg-blue-50 p-4">
                <p className="text-blue-900 text-sm">
                  📧 Check your email for a confirmation message. If you don't see it, please check
                  your spam folder.
                </p>
              </div>
            ...
            <div className="mb-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
                ...
                <p className="text-neutral-600 text-sm">
                  Dedicated English-speaking coordinator who understands expat needs and manages
                  your entire search.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
                ...
                <p className="text-neutral-600 text-sm">
                  Receive detailed professional profiles with bios, references, and availability
              ...
              <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
                ...
                <p className="text-neutral-600 text-sm">
                  Communicate entirely in English throughout the entire process — from search to
                  hiring.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
                ...
                <p className="text-neutral-600 text-sm">
                  We schedule and facilitate video or in-person interviews, and help negotiate terms
              ...
              <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
                ...
                <p className="text-neutral-600 text-sm">
                  Continued assistance after hiring with contract templates, payment setup, and any
                  issues that arise.
                </p>
              </div>
            </div>
