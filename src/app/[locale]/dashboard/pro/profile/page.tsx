...
export default async function ProProfilePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <section className="space-y-6">
      {/* Header */}
      <div className="rounded-lg border border-neutral-200 bg-white p-8 dark:border-rausch-900/30 dark:bg-rausch-950/40">
        <h1 className="font-semibold text-3xl text-neutral-900 dark:text-neutral-100">{t("title")}</h1>
        <p className="mt-2 text-base text-neutral-600 leading-relaxed dark:text-neutral-400">{t("description")}</p>
      </div>
