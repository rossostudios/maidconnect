...
/**
 * Customer Dashboard Error Boundary
 *
 * Catches errors in customer dashboard routes and displays a fallback UI.
 * Prevents customer dashboard errors from crashing the entire app.
 */
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-8 shadow-sm">
          ...
          <p className="mb-6 text-center text-neutral-700">
            An error occurred while loading your dashboard. This has been logged and our team has
            been notified.
          </p>
