...
export function ProfessionalsDirectory() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="mb-2 font-bold text-3xl text-neutral-900">Find Professionals</h1>
        <p className="text-neutral-600">Browse verified home service professionals in your area</p>
      </div>
      ...
      <div className="mb-4">
        <QuickFilters filters={filters} setFilter={setFilter} />
      </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <p className="text-neutral-600 text-sm">
            {isLoading ? (
              ...
              <>
                <span className="font-semibold text-neutral-900">{totalResults}</span> professionals
                found
              </>
            )}
          </p>
