      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <div className="mt-3 space-y-2">
            ...
            <ul className="ml-6 list-disc space-y-1 text-neutral-500">
        ...
        <section>
          ...
          <div className="space-y-3">
            <div>
              ...
              <ul className="mt-2 ml-6 list-disc space-y-1 text-neutral-500">
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <ul className="mt-1 ml-6 list-disc space-y-1 text-neutral-500">
        ...
        <section>
          ...
          <ul className="ml-6 list-disc space-y-2 text-neutral-500">
            <li>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div>
              ...
              <ol className="ml-6 list-decimal space-y-1 text-neutral-500">
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <p className="mt-3 text-neutral-500">En caso de disputa, el usuario debe:</p>
            <ol className="ml-6 list-decimal space-y-1 text-neutral-500">
        ...
        <section>
          ...
          <ul className="mt-2 ml-6 list-none space-y-1 text-neutral-500">
            <li>
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="text-neutral-500">For questions about these Terms, contact us:</p>
          <ul className="mt-2 ml-6 list-none space-y-1 text-neutral-500">
            <li>
