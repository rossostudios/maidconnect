...
function SpanishTerms({ lastUpdated }: { lastUpdated: string }) {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="mb-2 font-bold text-4xl text-[#116611616]">Términos y Condiciones de Uso</h1>
        <p className="text-[#AA88AAAAC] text-sm">Última actualización: {lastUpdated}</p>
      </div>

      <div className="space-y-6">
        <section>
          <h2 className="mb-3 font-semibold text-2xl text-[#116611616]">
          ...
          <p className="mt-3 text-[#AA88AAAAC]">
        ...
        <section>
          ...
          <div className="mt-3 space-y-2">
            ...
            <ul className="ml-6 list-disc space-y-1 text-[#AA88AAAAC]">
        ...
        <section>
          ...
          <div className="space-y-3">
            <div>
              ...
              <ul className="mt-2 ml-6 list-disc space-y-1 text-[#AA88AAAAC]">
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <div>
              <h3 className="mb-2 font-semibold text-[#116611616] text-lg">4.2 Tipos de Cuenta</h3>
              <p className="text-[#AA88AAAAC]">
              ...
              <ul className="mt-1 ml-6 list-disc space-y-1 text-[#AA88AAAAC]">
        ...
        <section>
          ...
          <ul className="ml-6 list-disc space-y-2 text-[#AA88AAAAC]">
            <li>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div>
              ...
              <ol className="ml-6 list-decimal space-y-1 text-[#AA88AAAAC]">
        ...
        <section>
          <h2 className="mb-3 font-semibold text-2xl text-[#116611616]">8. Pagos y Comisiones</h2>
          <div className="space-y-3">
            <div>
              <h3 className="mb-2 font-semibold text-[#116611616] text-lg">
            ...
            <div>
              <h3 className="mb-2 font-semibold text-[#116611616] text-lg">8.4 Reembolsos</h3>
              <p className="text-[#AA88AAAAC]">
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <p className="mt-3 text-[#AA88AAAAC]">En caso de disputa, el usuario debe:</p>
            <ol className="ml-6 list-decimal space-y-1 text-[#AA88AAAAC]">
        ...
        <section>
          <h2 className="mb-3 font-semibold text-2xl text-[#116611616]">13. Indemnización</h2>
          <p className="text-[#AA88AAAAC]">
        ...
        <section>
          ...
          <div className="space-y-3">
            <div>
              <h3 className="mb-2 font-semibold text-[#116611616] text-lg">14.1 Por Casaora</h3>
              <p className="text-[#AA88AAAAC]">
            ...
            <div>
              <h3 className="mb-2 font-semibold text-[#116611616] text-lg">14.2 Por el Usuario</h3>
              <p className="text-[#AA88AAAAC]">
        ...
        <section>
          ...
          <ul className="mt-2 ml-6 list-none space-y-1 text-[#AA88AAAAC]">
            <li>
...
function EnglishTerms({ lastUpdated }: { lastUpdated: string }) {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="mb-2 font-bold text-4xl text-[#116611616]">Terms and Conditions of Use</h1>
        <p className="text-[#AA88AAAAC] text-sm">Last updated: {lastUpdated}</p>
      </div>

      <div className="space-y-6">
        <section>
          <h2 className="mb-3 font-semibold text-2xl text-[#116611616]">1. Acceptance of Terms</h2>
          <p className="text-[#AA88AAAAC]">
        ...
        <section>
          <h2 className="mb-3 font-semibold text-2xl text-[#116611616]">2. Service Description</h2>
          <p className="text-[#AA88AAAAC]">
        ...
        <section>
          <h2 className="mb-3 font-semibold text-2xl text-[#116611616]">4. Payment Processing</h2>
          <p className="text-[#AA88AAAAC]">
        ...
        <section>
          <h2 className="mb-3 font-semibold text-2xl text-[#116611616]">5. Cancellation Policy</h2>
          <ul className="ml-6 list-disc space-y-1 text-[#AA88AAAAC]">
            <li>
        ...
        <section>
          <h2 className="mb-3 font-semibold text-2xl text-[#116611616]">7. Governing Law</h2>
          <p className="text-[#AA88AAAAC]">
        ...
        <section>
          <h2 className="mb-3 font-semibold text-2xl text-[#116611616]">8. Contact Information</h2>
          <p className="text-[#AA88AAAAC]">For questions about these Terms, contact us:</p>
          <ul className="mt-2 ml-6 list-none space-y-1 text-[#AA88AAAAC]">
            <li>
