  ...
  return (
    <section className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-bold text-3xl text-stone-900">Roadmap Management</h1>
          <p className="mt-2 text-stone-600">Manage your product roadmap items</p>
        </div>

        <Link
          className="inline-flex items-center gap-2 rounded-lg bg-stone-900 px-6 py-3 font-medium text-white transition hover:bg-stone-800"
