            ...
            >
              <div className="flex items-start justify-between gap-4">
                  ...
                  {changelog.categories.length > 0 && (
                    <div className="flex flex-wrap gap-2">
                      {changelog.categories.map((category: string) => {
                        ...
                        return (
                          <span
                            className={`-full flex items-center gap-1 px-2 py-1 font-medium text-xs ${config.color}`}
                            key={category}
                          >
                ...
                <div className="flex flex-col gap-2">
                  <Link
                    className="flex items-center gap-2 border border-neutral-200 px-3 py-2 font-medium text-neutral-600 text-sm transition hover:border-neutral-300 hover:bg-neutral-50 hover:text-neutral-900"
