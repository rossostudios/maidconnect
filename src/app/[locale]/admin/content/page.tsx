...
export default async function AdminContentPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="mb-6">
        <h1 className="mb-2 font-bold text-3xl text-slate-900">Content Management</h1>
        <div className="flex items-center justify-between">
          <p className="text-slate-600 text-sm">Manage all website content powered by Sanity CMS</p>
          <Link
            className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 font-medium text-slate-900 text-sm transition hover:border-slate-300 hover:shadow-sm"
            href="/studio"
            target="_blank"
          >
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm ring-1 ring-black/5">
          <div className="mb-1 font-medium text-slate-600 text-sm">Total Content</div>
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm ring-1 ring-black/5">
          <div className="mb-1 font-medium text-slate-600 text-sm">Help Articles</div>
          <div className="font-bold text-3xl text-slate-900">{stats.helpArticles}</div>
        </div>
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm ring-1 ring-black/5">
          <div className="mb-1 font-medium text-slate-600 text-sm">Published</div>
          <div className="font-bold text-3xl text-slate-900">{stats.publishedArticles}</div>
        </div>
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm ring-1 ring-black/5">
          <div className="mb-1 font-medium text-slate-600 text-sm">Drafts</div>
          <div className="font-bold text-3xl text-slate-900">{stats.draftArticles}</div>
        </div>
      </div>

      {/* Content Types Grid */}
      <div>
        <h2 className="mb-4 font-bold text-2xl text-slate-900">Content Types</h2>
          ...
          {contentTypes.map((contentType) => (
            ...
            >
              ...
              <div className="mb-4 flex items-center gap-3">
                <HugeiconsIcon className="h-5 w-5 text-slate-600" icon={contentType.icon} />
                <h3 className="font-semibold text-base text-slate-900">{contentType.title}</h3>
              </div>
              <p className="mb-4 text-slate-600 text-sm">{contentType.description}</p>

              {/* Stats */}
              <div className="mb-4 space-y-2 border-slate-200 border-t pt-4">
              ...
              <div className="flex gap-2">
                <Link
                  className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 font-medium text-slate-900 text-sm transition hover:border-slate-300 hover:bg-slate-50"
                ...
                <Link
                  ...
                  className="rounded-lg border border-slate-200 bg-white px-4 py-2 font-medium text-slate-900 text-sm transition hover:border-slate-300 hover:bg-slate-50"
      ...
      {/* Recent Activity */}
      <div>
        <h2 className="mb-4 font-bold text-2xl text-slate-900">Recent Activity</h2>
        <div className="grid gap-4 lg:grid-cols-2">
          {/* Recent Articles */}
          <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm ring-1 ring-black/5">
            <h3 className="mb-4 font-semibold text-base text-slate-900">Recent Help Articles</h3>
              ...
              {recent.recentArticles.map((article: any) => (
                ...
                >
                  <div className="min-w-0 flex-1">
                    <div className="truncate font-medium text-slate-900">{article.title}</div>
                    <div className="mt-1 flex items-center gap-2">
                      ...
                      {article.isPublished ? (
                        ...
                        <span className="rounded bg-slate-100 px-2 py-0.5 text-slate-700 text-xs">
                          Draft
                        </span>
                      )}
                    </div>
                  ...
                  <HugeiconsIcon
                    className="ml-2 h-4 w-4 flex-shrink-0 text-slate-600 opacity-0 transition-opacity group-hover:opacity-100"
          ...
          {/* Recent Changelogs */}
          <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm ring-1 ring-black/5">
            <h3 className="mb-4 font-semibold text-base text-slate-900">
            ...
            <div className="space-y-3">
              {recent.recentChangelogs.map((changelog: any) => (
                ...
                >
                  <div className="min-w-0 flex-1">
                    <div className="truncate font-medium text-slate-900">{changelog.title}</div>
                    <div className="mt-1 flex items-center gap-2">
                      <span className="text-slate-600 text-xs">
