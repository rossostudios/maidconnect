...
export default async function AdminContentPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="mb-6">
        <h1 className="mb-2 font-bold text-3xl text-neutral-900">Content Management</h1>
      ...
      {/* Content Types Grid */}
      <div>
        <h2 className="mb-4 font-bold text-2xl text-neutral-900">Content Types</h2>
          ...
          {contentTypes.map((contentType) => (
            ...
            >
              ...
              <div className="mb-4 flex items-center gap-3">
                <HugeiconsIcon className="h-5 w-5 text-neutral-600" icon={contentType.icon} />
                <h3 className="font-semibold text-base text-neutral-900">{contentType.title}</h3>
              </div>
              <p className="mb-4 text-neutral-600 text-sm">{contentType.description}</p>

              {/* Stats */}
              <div className="mb-4 space-y-2 border-neutral-200 border-t pt-4">
              ...
              {recent.recentArticles.map((article: any) => (
                ...
                >
                  <div className="min-w-0 flex-1">
                    <div className="truncate font-medium text-neutral-900">{article.title}</div>
                    <div className="mt-1 flex items-center gap-2">
                      <span className="text-neutral-600 text-xs">{article.category}</span>
                  ...
                  <HugeiconsIcon
                    className="ml-2 h-4 w-4 flex-shrink-0 text-neutral-600 opacity-0 transition-opacity group-hover:opacity-100"
          ...
          <div className="border border-neutral-200 bg-white p-6 shadow-sm ring-1 ring-black/5">
            ...
            <div className="space-y-3">
              {recent.recentChangelogs.map((changelog: any) => (
                ...
                >
                  <div className="min-w-0 flex-1">
                    <div className="truncate font-medium text-neutral-900">{changelog.title}</div>
                    <div className="mt-1 flex items-center gap-2">
                      <span className="text-neutral-600 text-xs">
