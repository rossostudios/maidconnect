    ...
    <div className="mx-auto flex min-h-screen w-full max-w-2xl flex-col items-center justify-center px-6 py-16 text-center text-[#211f1a]">
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
          <Link
            className="rounded-full border border-[#211f1a] bg-[#211f1a] px-5 py-2 font-semibold text-sm text-white shadow-sm transition hover:border-[#ff5d46] hover:bg-[#2b2624]"
            href="mailto:support@maidconnect.com"
          >
            Email support
          </Link>
          <Link
            className="rounded-full border border-[#211f1a] px-5 py-2 font-semibold text-[#211f1a] text-sm transition hover:border-[#ff5d46]"
