...
export default function AccountSuspendedPage() {
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-2xl flex-col items-center justify-center px-6 py-16 text-center text-[var(--foreground)]">
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            className="rounded-full border border-[var(--foreground)] px-5 py-2 font-semibold text-[var(--foreground)] text-sm transition hover:border-[var(--red)]"
