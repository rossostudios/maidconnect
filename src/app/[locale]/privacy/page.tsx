    ...
    <>
      ...
      <div className="prose prose-lg max-w-none space-y-8">
        ...
        <section>
          ...
          <div className="mb-4 rounded-lg border border-[#ebe5d8] bg-[#fbf9f7] p-4">
            ...
            <p className="mb-2 text-gray-900">
              ...
              <a className="text-[#E85D48] hover:underline" href="mailto:privacy@casaora.com">
                privacy@casaora.com
              </a>
            </p>
            <p className="mb-2 text-gray-900">
        ...
        <section>
          ...
          <h3 className="mb-3 font-semibold text-gray-900 text-xl">2.1 Datos de Identificación</h3>
          ...
          <h3 className="mb-3 font-semibold text-gray-900 text-xl">2.2 Datos de Ubicación</h3>
          <ul className="mb-4 ml-6 list-disc text-[#7d7566]">
          ...
          <h3 className="mb-3 font-semibold text-gray-900 text-xl">2.3 Datos Financieros</h3>
          <ul className="mb-4 ml-6 list-disc text-[#7d7566]">
        ...
        {/* Section 3 */}
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">3. Finalidades del Tratamiento</h2>
        ...
        <section>
          ...
          <div className="rounded-lg border-[#E85D48] border-l-4 bg-[#fff5f2] p-4">
            <h3 className="mb-2 font-semibold text-gray-900">¿Cómo Ejercer Sus Derechos?</h3>
            <p className="mb-2 text-[#7d7566]">
        ...
        {/* Section 6 */}
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">6. Compartir Datos con Terceros</h2>
          <p className="mb-4 text-[#7d7566]">
            Compartimos sus datos personales únicamente en las siguientes circunstancias:
          </p>

          <h3 className="mb-3 font-semibold text-gray-900 text-xl">6.1 Proveedores de Servicios</h3>
          <div className="mb-4 space-y-2">
            <div className="rounded-lg border border-[#ebe5d8] bg-white p-3">
              <p className="mb-1 font-semibold text-gray-900">Stripe Inc. (Estados Unidos)</p>
              <p className="text-[#7d7566] text-sm">
                Finalidad: Procesamiento de pagos | Certificación: PCI DSS Level 1
              </p>
            </div>
            <div className="rounded-lg border border-[#ebe5d8] bg-white p-3">
              <p className="mb-1 font-semibold text-gray-900">Supabase Inc. (Estados Unidos)</p>
              <p className="text-[#7d7566] text-sm">
                Finalidad: Almacenamiento de base de datos | Certificación: SOC 2 Type II
              </p>
            </div>
            <div className="rounded-lg border border-[#ebe5d8] bg-white p-3">
              <p className="mb-1 font-semibold text-gray-900">Vercel Inc. (Estados Unidos)</p>
              <p className="text-[#7d7566] text-sm">
          ...
          <h3 className="mb-3 font-semibold text-gray-900 text-xl">6.2 Entre Usuarios</h3>
          <p className="mb-4 text-[#7d7566]">
          ...
          <p className="font-semibold text-[#E85D48]">
        ...
        {/* Section 7 */}
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">7. Medidas de Seguridad</h2>
          <p className="mb-4 text-[#7d7566]">
        ...
        {/* Section 8 */}
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">8. Retención de Datos</h2>
          <p className="mb-4 text-[#7d7566]">
        ...
        {/* Section 11 */}
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">11. Menores de Edad</h2>
          <p className="text-[#7d7566]">
        ...
        {/* Section 13 */}
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">13. Autoridades de Control</h2>
          <p className="mb-4 text-[#7d7566]">
        ...
        {/* Section 14 */}
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">14. Contacto</h2>
          <p className="mb-4 text-[#7d7566]">
        ...
        {/* Legal Declaration */}
        <section className="rounded-lg border-2 border-[#E85D48] bg-[#fff5f2] p-6">
          <h2 className="mb-4 font-bold text-gray-900 text-xl">Declaración de Consentimiento</h2>
...
function EnglishPrivacyPolicy({ lastUpdated }: { lastUpdated: string }) {
  return (
    <>
      ...
      <div className="prose prose-lg max-w-none space-y-8">
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">1. Data Controller</h2>
          <div className="mb-4 rounded-lg border border-[#ebe5d8] bg-[#fbf9f7] p-4">
            <p className="mb-2 text-gray-900">
        ...
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">2. Personal Data We Collect</h2>

          <h3 className="mb-3 font-semibold text-gray-900 text-xl">2.1 Identification Data</h3>
          <ul className="mb-4 ml-6 list-disc text-[#7d7566]">
          ...
          <h3 className="mb-3 font-semibold text-gray-900 text-xl">2.2 Location Data</h3>
          <ul className="mb-4 ml-6 list-disc text-[#7d7566]">
          ...
          <h3 className="mb-3 font-semibold text-gray-900 text-xl">2.3 Financial Data</h3>
          <ul className="mb-4 ml-6 list-disc text-[#7d7566]">
        ...
        <section>
          ...
          <div className="rounded-lg border-[#E85D48] border-l-4 bg-[#fff5f2] p-4">
            <h3 className="mb-2 font-semibold text-gray-900">How to Exercise Your Rights</h3>
        ...
        <section>
          ...
          <div className="mb-4 space-y-2">
            <div className="rounded-lg border border-[#ebe5d8] bg-white p-3">
              <p className="mb-1 font-semibold text-gray-900">Stripe Inc. (USA)</p>
              <p className="text-[#7d7566] text-sm">
                Purpose: Payment processing | Certification: PCI DSS Level 1
              </p>
            </div>
            <div className="rounded-lg border border-[#ebe5d8] bg-white p-3">
              <p className="mb-1 font-semibold text-gray-900">Supabase Inc. (USA)</p>
              <p className="text-[#7d7566] text-sm">
                Purpose: Database storage | Certification: SOC 2 Type II
              </p>
            </div>
            <div className="rounded-lg border border-[#ebe5d8] bg-white p-3">
              <p className="mb-1 font-semibold text-gray-900">Vercel Inc. (USA)</p>
              <p className="text-[#7d7566] text-sm">
        ...
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">5. Security Measures</h2>
          <ul className="mb-4 ml-6 list-disc text-[#7d7566]">
            <li>
        ...
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">6. Data Retention</h2>
          <ul className="mb-4 ml-6 list-disc text-[#7d7566]">
            <li>
        ...
        <section>
          <h2 className="mb-4 font-bold text-2xl text-gray-900">7. Contact</h2>
          <div className="rounded-lg border border-[#ebe5d8] bg-white p-4">
            <p className="mb-2 text-gray-900">
              <strong>Email:</strong>{" "}
              <a className="text-[#E85D48] hover:underline" href="mailto:privacy@casaora.com">
        ...
        <section className="rounded-lg border-2 border-[#E85D48] bg-[#fff5f2] p-6">
          <h2 className="mb-4 font-bold text-gray-900 text-xl">Consent Declaration</h2>
