...
export function QuickReplies({ onSelectReply }: QuickRepliesProps) {
  ...
  if (!isExpanded) {
    return (
      <button
        className="flex items-center gap-2 rounded-lg border border-stone-200 bg-white px-4 py-2 font-medium text-sm text-stone-700 shadow-sm transition-all hover:border-stone-300 hover:bg-stone-50"
  ...
  return (
    <div className="rounded-lg border border-stone-200 bg-white p-4 shadow-sm">
      ...
      <div className="mb-3 flex items-center justify-between">
        <h3 className="font-semibold text-sm text-stone-900">Quick Reply Templates</h3>
        <button
