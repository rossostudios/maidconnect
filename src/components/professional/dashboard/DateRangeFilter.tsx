      ...
      {periods.map((period) => {
        ...
        return (
          <button
            ...
            className={cn(
              "rounded-md font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-1",
...
export function DateRangeDropdown({ value, onChange, className }: DateRangeDropdownProps) {
  return (
    <select
      ...
      className={cn(
        "rounded-lg border border-neutral-200 bg-white px-3 py-1.5 text-sm font-medium text-neutral-700",
