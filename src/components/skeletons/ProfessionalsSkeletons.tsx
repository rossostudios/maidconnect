    ...
    <section className="py-16 sm:py-20 lg:py-24">
      <div className="container mx-auto max-w-7xl px-6">
        <div aria-label="Loading professionals" className="space-y-6" role="status">
          ...
          <div className="animate-pulse space-y-6 rounded-[32px] border border-neutral-200 bg-[neutral-50] p-8 shadow-[0_10px_40px_rgba(22,22,22,0.04)]">
          ...
          {[1, 2, 3].map((i) => (
            <div
              className="animate-pulse overflow-hidden rounded-lg border border-neutral-200 bg-[neutral-50] p-6 shadow-[0_10px_40px_rgba(22,22,22,0.04)]"
              key={i}
            >
              {/* Header Row */}
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="flex items-start gap-4">
                  <div className="h-16 w-16 flex-shrink-0 rounded-full bg-neutral-200" />
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <div className="h-7 w-40 rounded-full bg-[neutral-50]" />
                <div className="h-7 w-36 rounded-full bg-[neutral-500]/10" />
              </div>
...
export function ProfessionalProfileHeroSkeleton() {
  return (
    <div
      ...
      className="animate-pulse rounded-[32px] border border-neutral-200 bg-[neutral-50] p-8"
      role="status"
    >
      <div className="flex flex-col gap-6 md:flex-row">
        {/* Avatar */}
        <div className="h-32 w-32 flex-shrink-0 rounded-full bg-neutral-200" />
        ...
        <div className="flex-1 space-y-4">
          ...
          {/* Button */}
          <div className="h-12 w-48 rounded-full bg-neutral-200" />
        </div>
      </div>
    </div>
  );
...
export function AvailabilityCalendarSkeleton() {
  return (
    <div
      ...
      className="animate-pulse rounded-lg border border-neutral-200 bg-[neutral-50] p-6"
      role="status"
    >
      {/* Calendar header */}
