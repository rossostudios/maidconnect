    ...
    <section className="py-16 sm:py-20 lg:py-24">
      <div className="container mx-auto max-w-7xl px-6">
        <div aria-label="Loading professionals" className="space-y-6" role="status">
          ...
          <div className="animate-pulse space-y-6 border border-neutral-200 bg-[neutral-50] p-8 shadow-[0_10px_40px_rgba(22,22,22,0.04)]">
          ...
          {[1, 2, 3].map((i) => (
            <div
              className="animate-pulse overflow-hidden border border-neutral-200 bg-[neutral-50] p-6 shadow-[0_10px_40px_rgba(22,22,22,0.04)]"
              key={i}
            >
              {/* Header Row */}
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="flex items-start gap-4">
                  <div className="h-16 w-16 flex-shrink-0 bg-neutral-200" />
                ...
                <div className="flex items-center gap-3">
                  <div className="h-11 w-11 bg-neutral-200" />
                  <div className="h-11 w-32 bg-neutral-200" />
                </div>
              </div>

              {/* Activity Indicators Skeleton */}
              <div className="mt-4 flex flex-wrap gap-2">
                <div className="h-7 w-40 bg-[neutral-50]" />
                <div className="h-7 w-36 bg-[neutral-500]/10" />
              </div>

              {/* Stats Row */}
              <div className="mt-4 flex flex-wrap gap-6 border-neutral-200 border-b pb-4">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <div className="h-7 w-32 bg-neutral-200" />
              </div>
...
export function ProfessionalProfileHeroSkeleton() {
  return (
    <div
      ...
      className="animate-pulse border border-neutral-200 bg-[neutral-50] p-8"
      role="status"
    >
      <div className="flex flex-col gap-6 md:flex-row">
        {/* Avatar */}
        <div className="h-32 w-32 flex-shrink-0 bg-neutral-200" />
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="h-6 w-28 bg-neutral-200" />
          </div>
          ...
          {/* Button */}
          <div className="h-12 w-48 bg-neutral-200" />
        </div>
      </div>
    </div>
  );
...
export function AvailabilityCalendarSkeleton() {
  return (
    <div
      ...
      className="animate-pulse border border-neutral-200 bg-[neutral-50] p-6"
      role="status"
    >
      {/* Calendar header */}
    ...
    <div aria-label="Loading vetting queue" className="animate-pulse space-y-4" role="status">
      <div className="border border-neutral-200 bg-white p-6 shadow-sm ring-1 ring-black/5">
        ...
        <div className="mt-6 space-y-4">
          {[1, 2, 3].map((i) => (
            <div
              className="flex items-center justify-between border-neutral-200 border-b pb-4"
              key={i}
            >
              ...
              <div className="flex gap-2">
                <div className="h-10 w-24 bg-neutral-200" />
                <div className="h-10 w-24 bg-neutral-200" />
              </div>
            </div>
          ))}
