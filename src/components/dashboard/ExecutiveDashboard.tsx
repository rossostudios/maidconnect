    ...
    return (
      <div className="space-y-8">
        ...
        <div className="min-h-[60px]">
          <div className="flex items-center gap-4 rounded-lg border border-neutral-200 bg-white px-5 py-4 shadow-sm ring-1 ring-black/5">
        ...
        <div className="flex items-center justify-between">
          <div className="h-10 w-96 animate-pulse rounded-lg bg-neutral-50 will-change-[opacity]" />
          <div className="h-10 w-40 animate-pulse rounded-lg bg-neutral-50 will-change-[opacity]" />
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="h-[440px] animate-pulse rounded-lg border border-neutral-200 bg-white p-6 shadow-sm ring-1 ring-black/5 will-change-[opacity]">
              <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="h-12 w-12 animate-pulse rounded-lg bg-neutral-50 will-change-[opacity]" />
  ...
  return (
    <div className="space-y-8">
      ...
      {metrics.criticalAlerts.length > 0 ? (
          ...
          {metrics.criticalAlerts.map((alert) => (
            <div
              className={cn(
                ...
                alert.type === "critical" && "border-neutral-300 bg-neutral-100",
                alert.type === "warning" && "border-amber-200 bg-neutral-100",
                alert.type === "info" && "border-neutral-200 bg-neutral-50"
              )}
              key={alert.id}
            >
              <HugeiconsIcon
                className={cn(
                  ...
                  alert.type === "critical" && "text-neutral-800",
                  alert.type === "warning" && "text-neutral-500",
                  alert.type === "info" && "text-neutral-600"
                )}
                icon={Alert01Icon}
              />
        ...
        <div className="flex items-center gap-4 rounded-lg border border-neutral-200 bg-neutral-100 px-5 py-4 shadow-sm ring-1 ring-black/5">
          <HugeiconsIcon
            className="h-5 w-5 flex-shrink-0 text-neutral-700"
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <Card className="border-neutral-200 bg-white shadow-sm ring-1 ring-black/5 transition-shadow hover:shadow-lg lg:col-span-2">
              <CardHeader className="flex flex-row items-center justify-between pb-8">
                <div className="flex items-center gap-4">
                  <div className="rounded-lg bg-neutral-600/10 p-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="rounded-lg bg-neutral-50 p-2 transition-colors hover:bg-neutral-200"
                    ...
                    <AreaChart data={metrics.revenueData}>
                      <defs>
                        <linearGradient id="colorRevenue" x1="0" x2="0" y1="0" y2="1">
                          <stop offset="5%" stopColor="neutral-600" stopOpacity={0.1} />
                          <stop offset="95%" stopColor="neutral-600" stopOpacity={0} />
                        </linearGradient>
                      </defs>
              ...
              <Card className="border-neutral-200 bg-white shadow-sm ring-1 ring-black/5 transition-shadow hover:shadow-lg">
                <CardContent className="p-8">
                  <div className="mb-6 flex items-center gap-3">
                    <div className="rounded-lg bg-neutral-600/5 p-3">
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <Card className="border-neutral-200 bg-white shadow-sm ring-1 ring-black/5 transition-shadow hover:shadow-lg">
              <CardHeader className="flex flex-row items-center justify-between pb-6">
                <div className="flex items-center gap-4">
                  <div className="rounded-lg bg-neutral-900/10 p-3">
                  ...
                  <ResponsiveContainer height="100%" width="100%">
                    <BarChart data={metrics.bookingFunnelData} layout="vertical">
                      ...
                      <YAxis
                        ...
                        type="category"
                      />
                      <Bar dataKey="count" fill="neutral-600" radius={[0, 8, 8, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
