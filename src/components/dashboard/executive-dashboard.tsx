    ...
    return (
      <div className="space-y-8">
        ...
        <div className="min-h-[60px]">
          <div className="flex items-center gap-4 rounded-lg border border-slate-200 bg-white px-5 py-4 shadow-sm ring-1 ring-black/5">
            <div className="h-5 w-5 animate-pulse rounded bg-slate-50 will-change-[opacity]" />
            <div className="h-5 w-48 animate-pulse rounded bg-slate-50 will-change-[opacity]" />
          </div>
        </div>

        {/* Tabs & Filter skeleton */}
        <div className="flex items-center justify-between">
          <div className="h-10 w-96 animate-pulse rounded-lg bg-slate-50 will-change-[opacity]" />
          <div className="h-10 w-40 animate-pulse rounded-lg bg-slate-50 will-change-[opacity]" />
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="h-[440px] animate-pulse rounded-lg border border-slate-200 bg-white p-6 shadow-sm ring-1 ring-black/5 will-change-[opacity]">
              <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="h-12 w-12 animate-pulse rounded-lg bg-slate-50 will-change-[opacity]" />
                  <div className="space-y-2">
                    <div className="h-4 w-32 animate-pulse rounded bg-slate-50 will-change-[opacity]" />
                    <div className="h-8 w-24 animate-pulse rounded bg-slate-50 will-change-[opacity]" />
                  </div>
                </div>
              </div>
              <div className="h-64 animate-pulse rounded bg-slate-50 will-change-[opacity]" />
            </div>
          </div>
            ...
            <div className="space-y-6">
              {[1, 2, 3, 4].map((i) => (
                <div className="space-y-2" key={i}>
                  <div className="h-4 w-32 animate-pulse rounded bg-slate-50 will-change-[opacity]" />
                  <div className="h-8 w-20 animate-pulse rounded bg-slate-50 will-change-[opacity]" />
                </div>
              ))}
            </div>
          </div>
          ...
          {metrics.criticalAlerts.map((alert) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <span className="ml-3 text-slate-600 text-sm">{alert.description}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <Tabs className="w-full" onValueChange={setActiveTab} value={activeTab}>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <HugeiconsIcon className="h-5 w-5 text-slate-500" icon={Calendar03Icon} />
        ...
        <TabsContent value="overview">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <Card className="border-slate-200 bg-white shadow-sm ring-1 ring-black/5 transition-shadow hover:shadow-lg lg:col-span-2">
              <CardHeader className="flex flex-row items-center justify-between pb-8">
                <div className="flex items-center gap-4">
                  <div className="rounded-lg bg-slate-600/10 p-3">
                    <HugeiconsIcon className="h-7 w-7 text-slate-600" icon={DollarCircleIcon} />
                  </div>
                  <div>
                    ...
                    <p className="mt-1 text-slate-500 text-sm">Today's revenue</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <button
                    aria-label="Edit revenue settings"
                    className="rounded-lg bg-slate-50 p-2 transition-colors hover:bg-slate-200"
                    onClick={() => alert("Edit revenue tracking settings - Feature coming soon!")}
                  >
                    <HugeiconsIcon className="h-4 w-4 text-slate-500" icon={Edit02Icon} />
                  </button>
                  <button
            ...
            <div className="space-y-6">
              {/* Pending Bookings */}
              <Card className="border-slate-200 bg-white shadow-sm ring-1 ring-black/5 transition-shadow hover:shadow-lg">
                <CardContent className="p-8">
                  <div className="mb-6 flex items-center gap-3">
                    <div className="rounded-lg bg-slate-600/5 p-3">
                  ...
                  <p className="mb-2 font-bold text-4xl text-slate-900">
              ...
              <Card className="border-slate-200 bg-white shadow-sm ring-1 ring-black/5 transition-shadow hover:shadow-lg">
                <CardContent className="p-8">
                  ...
                  <p className="mb-2 font-bold text-4xl text-slate-900">{metrics.activeBookings}</p>
              ...
              <CardHeader className="flex flex-row items-center justify-between pb-6">
                <div className="flex items-center gap-4">
                  <div className="rounded-lg bg-slate-900/10 p-3">
                    <HugeiconsIcon className="h-6 w-6 text-slate-900" icon={UserMultiple02Icon} />
                  </div>
                  <div>
                    <p className="mb-1 font-semibold text-slate-500 text-xs uppercase tracking-wider">
            ...
            <Card className="border-slate-200 bg-white shadow-sm ring-1 ring-black/5 transition-shadow hover:shadow-lg">
              <CardHeader className="flex flex-row items-center justify-between pb-6">
                <div>
                  ...
                  <p className="text-slate-500 text-sm">Conversion pipeline</p>
                </div>
                <div className="flex items-center gap-2">
                  <button
        ...
        <TabsContent value="revenue">
          <div className="py-20 text-center">
            <p className="text-slate-500">Revenue analytics coming soon...</p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="supply">
          <div className="py-20 text-center">
            <p className="text-slate-500">Supply management coming soon...</p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="bookings">
          <div className="py-20 text-center">
            <p className="text-slate-500">Booking analytics coming soon...</p>
          </div>
        </TabsContent>
      </Tabs>
    </div>
