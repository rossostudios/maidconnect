          ...
          {metrics.criticalAlerts.map((alert) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <span className="font-semibold text-stone-900 text-sm">{alert.title}</span>
                <span className="ml-3 text-stone-600 text-sm">{alert.description}</span>
              </div>
            </div>
          ))}
        </div>
      ) : (
        <div className="flex items-center gap-4 rounded-lg border border-green-200 bg-green-50 px-5 py-4 shadow-sm ring-1 ring-black/5">
          <HugeiconsIcon
              ...
              <CardHeader className="flex flex-row items-center justify-between pb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-stone-500 text-sm">Today's revenue</p>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="border-stone-200 bg-white shadow-sm ring-1 ring-black/5 transition-shadow hover:shadow-lg">
                <CardContent className="p-8">
                  ...
                  <p className="text-stone-500 text-sm">Awaiting acceptance</p>
                </CardContent>
              </Card>
            ...
            <Card className="border-stone-200 bg-white shadow-sm ring-1 ring-black/5 transition-shadow hover:shadow-lg">
              <CardHeader className="flex flex-row items-center justify-between pb-6">
                <div>
                  ...
                  <p className="text-stone-500 text-sm">Conversion pipeline</p>
                </div>
                <div className="flex items-center gap-2">
                  <button
