            ...
            <Card className="border-stone-200 bg-white transition-shadow hover:shadow-lg">
              <CardHeader className="flex flex-row items-center justify-between pb-6">
                <div>
                  ...
                  <p className="text-sm text-stone-500">Bookings by lifecycle stage</p>
                </div>
            ...
            <Card className="border-stone-200 bg-white transition-shadow hover:shadow-lg">
              <CardHeader className="flex flex-row items-center justify-between pb-6">
                <div>
                  ...
                  <p className="text-sm text-stone-500">Current conversion metrics</p>
                </div>
                <div className="flex items-center gap-2">
                  <button
              ...
              <CardContent className="pt-0">
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="mb-2 flex items-center justify-between">
                      <span className="text-sm text-stone-500">Pending Acceptance</span>
                      <span className="font-bold text-lg text-stone-900">
                        {totalActive > 0
