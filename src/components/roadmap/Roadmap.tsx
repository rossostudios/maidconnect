...
export function RoadmapAdminList() {
  ...
  const getStatusBadge = (visibility: RoadmapVisibility) => {
    const colors = {
      ...
      published: "bg-stone-100 text-stone-700 border-stone-200",
      archived: "bg-stone-100 text-amber-700 border-amber-200",
    };
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      type="button"
                    >
                      <HugeiconsIcon className="text-stone-800" icon={Delete01Icon} size={18} />
                    </button>
                  </div>
                </div>
              </div>
