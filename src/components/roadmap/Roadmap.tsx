...
export function RoadmapAdminList() {
  ...
  const getStatusBadge = (visibility: RoadmapVisibility) => {
    const colors = {
      ...
      published: "bg-neutral-100 text-neutral-700 border-neutral-200",
      archived: "bg-neutral-100 text-amber-700 border-amber-200",
    };
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="py-12 text-center">
          ...
          <Link
            className="inline-flex items-center gap-2 bg-neutral-900 px-6 py-3 font-medium text-white transition-all hover:bg-neutral-800"
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      type="button"
                    >
                      <HugeiconsIcon className="text-neutral-800" icon={Delete01Icon} size={18} />
                    </button>
                  </div>
                </div>
              </div>
