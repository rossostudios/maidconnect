        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center gap-4 py-12 text-center">
            ...
            <div className="flex flex-col gap-2">
              <h3 className="serif-headline-sm text-[neutral-900]">{t("empty.title")}</h3>
              <p className="text-[neutral-400]">{t("empty.description")}</p>
            </div>
          </div>
        ) : (
              ...
              <>
                ...
                {itemsByStatus.in_progress && itemsByStatus.in_progress.length > 0 && (
                  <div className="flex flex-col gap-4">
                    <h2 className="serif-headline-md flex items-center gap-2 text-[neutral-900]">
