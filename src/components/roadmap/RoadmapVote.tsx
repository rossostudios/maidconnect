...
import { useRoadmapVote } from "@/hooks/useRoadmap";
  ...
  return (
    <div className="relative">
      ...
      {showSignInPrompt && !canVote && (
        <div className="-transtone-x-1/2 absolute bottom-full left-1/2 z-10 mb-2 whitespace-nowrap rounded-lg bg-[#0f172a] px-3 py-2 text-[#f8fafc] text-sm">
          Sign in to vote
          <div className="-transtone-x-1/2 -mt-1 absolute top-full left-1/2">
