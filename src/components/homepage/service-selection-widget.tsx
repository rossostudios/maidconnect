    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center sm:mb-10 lg:mb-12">
          ...
          <p className="mx-auto mt-3 max-w-2xl font-[family-name:var(--font-geist-sans)] text-neutral-700 text-sm sm:mt-4 sm:text-base">
            {t("description")}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
          ...
          <Link
            className="group hover:-translate-y-1 block transform transition-all duration-200"
            href="/professionals"
          >
            <div className="flex h-full flex-col rounded-lg border-2 border-orange-200 bg-orange-50 p-6 shadow-sm transition-all hover:border-orange-300 hover:shadow-md sm:p-8">
              ...
              <div className="mb-4 inline-flex items-center justify-center rounded-full bg-orange-100 p-3">
                <HugeiconsIcon className="h-6 w-6 text-orange-600 sm:h-8 sm:w-8" icon={SparklesIcon} />
              </div>
              ...
              <p className="mb-4 flex-1 font-[family-name:var(--font-geist-sans)] text-neutral-700 text-sm leading-relaxed sm:mb-6 sm:text-base">
              ...
              {/* CTA Button */}
              <div className="inline-flex w-full items-center justify-center rounded-lg border-2 border-orange-600 bg-orange-600 px-6 py-3 font-[family-name:var(--font-geist-sans)] font-semibold text-white transition-all group-hover:border-orange-700 group-hover:bg-orange-700">
                {t("quickJob.cta")}
                <svg
          ...
          >
            <div className="flex h-full flex-col rounded-lg border-2 border-blue-200 bg-blue-50 p-6 shadow-sm transition-all hover:border-blue-300 hover:shadow-md sm:p-8">
              ...
              <div className="mb-4 inline-flex items-center justify-center rounded-full bg-blue-100 p-3">
                <HugeiconsIcon className="h-6 w-6 text-blue-600 sm:h-8 sm:w-8" icon={UserMultiple02Icon} />
              </div>
              ...
              {/* CTA Button */}
              <div className="inline-flex w-full items-center justify-center rounded-lg border-2 border-blue-600 bg-blue-600 px-6 py-3 font-[family-name:var(--font-geist-sans)] font-semibold text-white transition-all group-hover:border-blue-700 group-hover:bg-blue-700">
                {t("longTermHire.cta")}
                <svg
                  aria-label="Arrow right icon"
                  className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1"
