...
export function RatingPromptModal({
  ...
  return (
    ...
    >
      {/* Overall Rating */}
      <div>
        <div className="mb-2 block font-medium text-[neutral-900] text-sm">Overall Rating *</div>
        <StarRating
      ...
      {/* Title */}
      <div>
        <label className="mb-2 block font-medium text-[neutral-900] text-sm" htmlFor="title">
          Title (optional)
        </label>
        <input
      ...
      {/* Comment */}
      <div>
        <label className="mb-2 block font-medium text-[neutral-900] text-sm" htmlFor="comment">
          Comment (optional)
        </label>
        <textarea
          className="w-full border border-[neutral-200] px-3 py-2 text-sm focus:border-[neutral-500] focus:outline-none focus:ring-2 focus:ring-[neutral-500]/20"
