    ...
    <section className="bg-[neutral-50] px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto mb-12 max-w-3xl text-center">
          <h2 className="mb-4 font-bold text-3xl text-[neutral-900] sm:text-4xl">{t("title")}</h2>
        ...
        <div className="mx-auto mb-12 max-w-4xl rounded-2xl border border-[neutral-200] bg-[neutral-50] p-8 shadow-sm sm:p-12">
          <div className="mb-8 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[neutral-400] leading-relaxed">{t("remoteFirst.description")}</p>
            </div>
          </div>
          ...
          <div className="grid gap-6 pt-8 sm:grid-cols-3">
            <div className="text-center">
              <div className="mb-2 font-bold text-3xl text-[neutral-500]">
                {t("stats.locations")}
              </div>
              <p className="text-[neutral-400] text-sm">{t("stats.locationsLabel")}</p>
            </div>
            <div className="text-center">
              <div className="mb-2 font-bold text-3xl text-[neutral-500]">
                {t("stats.timezones")}
              </div>
              <p className="text-[neutral-400] text-sm">{t("stats.timezonesLabel")}</p>
            </div>
            <div className="text-center">
              <div className="mb-2 font-bold text-3xl text-[neutral-500]">
                {t("stats.languages")}
              </div>
              <p className="text-[neutral-400] text-sm">{t("stats.languagesLabel")}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {teamBenefits.map((benefit, index) => (
            ...
            >
              ...
              <p className="text-[neutral-400] text-sm">{t(benefit.descKey)}</p>
            </div>
          ))}
        </div>
