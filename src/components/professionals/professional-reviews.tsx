...
function ReviewCard({ review }: { review: ProfessionalReviewSummary }) {
  return (
    <li className="space-y-2 border border-[neutral-200] bg-[neutral-50] p-5">
  ...
  return (
    <section className="border border-[neutral-200] bg-[neutral-50] p-6 shadow-[0_24px_60px_rgba(22,22,22,0.06)]">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        {averageRating ? (
          <div className="flex items-center gap-2 border border-[neutral-200] bg-[neutral-50] px-4 py-2 font-semibold text-[neutral-900] text-sm">
            <HugeiconsIcon
              aria-hidden="true"
              className="h-4 w-4 fill-[neutral-500] text-[neutral-500]"
              icon={StarIcon}
      ...
      {canSubmit ? (
        <form
          action={formAction}
          className="mt-5 space-y-3 border border-[neutral-200] bg-[neutral-50] p-4"
        >
          ...
          <div className="grid gap-3 sm:grid-cols-[140px_1fr]">
            <label className="flex items-center gap-2 font-medium text-[neutral-900] text-sm">
              Rating
              <select
                className="border border-[neutral-200] bg-[neutral-50] px-3 py-1 font-medium text-[neutral-900] text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-[neutral-500] focus-visible:outline-offset-2"
                defaultValue="5"
                name="rating"
                required
              >
            ...
            <input
              className="w-full border border-[neutral-200] bg-[neutral-50] px-4 py-2 text-[neutral-900] text-sm focus:border-[neutral-500] focus:outline-none focus:ring-2 focus:ring-[neutral-500]/15"
              name="title"
          ...
          <textarea
            className="w-full border border-[neutral-200] bg-[neutral-50] px-4 py-3 text-[neutral-900] text-sm focus:border-[neutral-500] focus:outline-none focus:ring-2 focus:ring-[neutral-500]/15"
            name="comment"
          ...
          <div className="flex justify-end">
            <button
              className="inline-flex items-center justify-center border border-[neutral-900] bg-[neutral-900] px-5 py-2 font-semibold text-[neutral-50] text-sm shadow-sm transition hover:border-[neutral-500] hover:bg-[neutral-900] disabled:cursor-not-allowed disabled:opacity-60"
              disabled={pending}
              type="submit"
            >
        ...
        <div className="mt-5 border border-[neutral-200] border-dashed bg-[neutral-50] p-4 text-[neutral-400] text-sm">
          <p>
      ...
      <ul className="mt-6 space-y-4">
        {reviews.length === 0 ? (
          <li className="border border-[neutral-200] bg-[neutral-50] p-5 text-[neutral-400] text-sm">
