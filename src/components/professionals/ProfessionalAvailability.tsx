 ...
 * `@/components/professionals/ProfessionalAvailability` with this component.
 *
 * @example
 * ```tsx
 * // Before:
 * import { ProfessionalAvailabilityCalendar } from "@/components/professionals/ProfessionalAvailability";
 *
 * // After:
