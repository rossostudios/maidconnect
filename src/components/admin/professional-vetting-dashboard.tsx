    ...
    return (
      <Card className="border-stone-200 bg-stone-50">
        <CardContent className="p-8 text-center">
          ...
          <button
            className="rounded-lg bg-stone-600 px-6 py-3 font-semibold text-stone-50 text-sm transition-colors hover:bg-stone-600"
            onClick={fetchQueue}
            type="button"
          >
            Retry
      ...
      <Card className="border-stone-200 bg-stone-50 transition-shadow hover:shadow-lg">
        <CardHeader className="flex flex-row items-center justify-between pb-6">
          <div>
            ...
            <p className="text-stone-500 text-sm">Professionals by vetting status</p>
          </div>
        </CardHeader>
      ...
      <Tabs className="w-full" onValueChange={setActiveTab} value={activeTab}>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="mb-6 flex items-center gap-4">
                          ...
                          <span className="rounded-full bg-stone-600/10 px-3 py-1 font-semibold text-stone-600 text-sm">
                        ...
                        <div className="mb-6 grid grid-cols-2 gap-6 md:grid-cols-4">
                          ...
                          <div>
                            ...
                            <p className="font-bold text-2xl text-stone-900">
                              ...
                              <span className="ml-1 font-normal text-stone-500 text-sm">years</span>
                            </p>
                          </div>
                        ...
                        {professional.latestReview && (
                          <div className="mt-6 rounded-lg border border-stone-200 bg-stone-50 p-4">
                            ...
                            <p className="mb-1 text-stone-500 text-sm">
                            ...
                            {professional.latestReview.notes && (
                              <p className="mt-2 text-stone-900 text-sm">
                                {professional.latestReview.notes}
                              </p>
                            )}
                          </div>
                      ...
                      {/* Review Button */}
                      <button
                        className="ml-6 rounded-lg bg-stone-600 px-6 py-3 font-semibold text-stone-50 text-sm transition-colors hover:bg-stone-600"
          ...
          {activeProfessionals.length === 0 ? (
            <Card className="border-stone-200 bg-stone-50">
              <CardContent className="flex min-h-[400px] items-center justify-center">
                <p className="text-stone-500 text-sm">No approved professionals yet.</p>
              </CardContent>
            </Card>
          ) : (
            <div className="space-y-6">
                ...
                >
                  <CardContent className="p-8">
                    <div className="flex items-start justify-between">
                      ...
                      <button
                        className="ml-6 rounded-lg bg-stone-900 px-6 py-3 font-semibold text-stone-50 text-sm transition-colors hover:bg-stone-900"
                        onClick={() => setSelectedProfessional(professional)}
                        type="button"
                      >
                        View Details
        ...
        <TabsContent value="incomplete">
          {activeProfessionals.length === 0 ? (
            <Card className="border-stone-200 bg-stone-50">
              <CardContent className="flex min-h-[400px] items-center justify-center">
                <p className="text-stone-500 text-sm">No incomplete applications.</p>
              </CardContent>
            </Card>
          ) : (
            <div className="space-y-6">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="mb-6 flex items-center gap-4">
                          ...
                          <span className="rounded-full bg-stone-200/30 px-3 py-1 font-semibold text-stone-500 text-sm">
                            Incomplete
                          </span>
                        </div>
                      ...
                      <button
                        className="ml-6 rounded-lg bg-stone-500 px-6 py-3 font-semibold text-stone-50 text-sm transition-colors hover:bg-stone-500"
                        onClick={() => setSelectedProfessional(professional)}
                        type="button"
                      >
                        View Details
