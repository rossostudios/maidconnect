...
import { type Dispute, DisputesTable } from "./DisputesTable";
      ...
      <div className="space-y-4">
        ...
        >
          ...
          {activeFiltersCount > 0 && (
            <span className="ml-1 bg-[#FF5200] px-2 py-0.5 font-semibold text-white text-xs">
              {activeFiltersCount}
            </span>
          )}
        </button>
          ...
          <div className="border border-[#E5E5E5] bg-white p-6">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                <label
                  className="mb-2 block font-semibold text-[#A3A3A3] text-xs uppercase tracking-wider"
                  htmlFor="dispute-priority-filter"
                >
                  Priority
                </label>
                <select
                  className="w-full border border-[#E5E5E5] bg-white px-4 py-2.5 text-[#171717] focus:border-[#FF5200] focus:outline-none focus:ring-2 focus:ring-[#FF5200]"
                  id="dispute-priority-filter"
                  onChange={(e) => {
