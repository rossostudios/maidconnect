    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-neutral-200 bg-white p-6 dark:border-neutral-800 dark:bg-neutral-950">
        <div className="flex items-start justify-between">
          ...
          {!isChangingPassword && (
            <button
              className="rounded-lg border border-neutral-200 bg-white px-4 py-2 font-medium text-neutral-800 text-sm transition-colors hover:bg-white dark:border-neutral-800 dark:bg-neutral-950 dark:bg-neutral-950 dark:text-neutral-300"
