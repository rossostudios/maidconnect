      ...
      <div className="space-y-6">
        ...
        {form.error && (
          <div className="rounded-lg border border-neutral-300 bg-neutral-100 p-4 dark:border-red-800 dark:bg-red-950">
            <p className="type-body-sm text-neutral-800 dark:text-neutral-300">{form.error}</p>
          </div>
        )}
        ...
        <div className="flex gap-3 pt-4">
          ...
          <button
            className={
              "type-ui-sm flex-1 rounded-full px-6 py-3 font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-50 dark:text-neutral-950" +
              (isBanning
