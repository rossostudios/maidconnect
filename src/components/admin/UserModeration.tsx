...
function ModerationFooter({
  ...
  return (
    <div className="flex gap-3 pt-4">
      <button
        className="type-ui-sm -full flex-1 border-2 border-neutral-200 px-6 py-3 font-semibold text-neutral-900 transition hover:border-neutral-900 hover:text-neutral-900 disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-100 dark:border-neutral-800 dark:text-neutral-100"
        disabled={isLoading}
        onClick={onCancel}
        type="button"
      >
      ...
      <button
        className="type-ui-sm -full flex-1 bg-neutral-900 px-6 py-3 font-semibold text-white transition hover:bg-neutral-900 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-neutral-100 dark:text-neutral-950"
        disabled={isLoading}
        onClick={onSubmit}
        type="button"
      >
