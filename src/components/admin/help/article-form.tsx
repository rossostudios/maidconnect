    ...
    <div className="min-h-screen bg-white dark:bg-stone-950">
      ...
      <div className="border-stone-200 border-b bg-white px-6 py-4 dark:border-stone-800 dark:bg-stone-950">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              className="flex items-center gap-2 rounded-lg border border-stone-200 bg-white px-3 py-2 text-stone-600 text-sm transition-colors hover:bg-white dark:border-stone-800 dark:bg-stone-950 dark:bg-stone-950 dark:text-stone-400"
            ...
            <button
              className="rounded-lg border border-stone-200 bg-white px-4 py-2 text-stone-600 text-sm transition-colors hover:bg-white disabled:cursor-not-allowed disabled:opacity-50 dark:border-stone-800 dark:bg-stone-950 dark:bg-stone-950 dark:text-stone-400"
              disabled={saving}
              onClick={() => {
                handleSave(false);
              }}
              ...
              <div className={propertyCardClass}>
                ...
                <div className={cn(propertyRowClass, "mt-4 bg-white dark:bg-stone-950/60")}>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <span className="rounded-full bg-white px-3 py-1 font-medium text-stone-600 text-sm dark:bg-stone-950 dark:text-stone-400">
                      {isPublished
                        ? locale === "es"
                          ? "Publicado"
                          : "Published"
