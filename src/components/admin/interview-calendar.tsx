          ...
          <TabsList>
            <TabsTrigger value="scheduled">
              ...
              {data.counts.scheduled > 0 && (
                <span className="rounded-full ml-2 inline-flex items-center justify-center bg-white px-2 py-0.5 font-semibold text-neutral-900 text-xs dark:bg-neutral-950 dark:text-neutral-100">
                  {data.counts.scheduled}
                </span>
              )}
            </TabsTrigger>
