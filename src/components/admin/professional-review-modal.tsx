  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <section>
          ...
          <div className="mt-4">
            ...
            <div className="mt-1 flex flex-wrap gap-2">
              ...
              )) || <p className="text-stone-600 text-sm dark:text-stone-400">None listed</p>}
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          {professional.references_data && professional.references_data.length > 0 ? (
            ...
            <p className="text-stone-600 text-sm dark:text-stone-400">No references provided</p>
          )}
        </section>
        ...
        <section>
          ...
          {professional.documents.length > 0 ? (
            ...
            <p className="text-stone-600 text-sm dark:text-stone-400">No documents uploaded</p>
          )}
        </section>
      ...
      <div className="mt-6 flex justify-end gap-3">
        <button
          className="rounded-lg border border-stone-200 px-6 py-2 font-semibold text-red-700 text-sm transition hover:bg-white disabled:opacity-50 dark:border-stone-800 dark:bg-stone-950 dark:text-red-200"
