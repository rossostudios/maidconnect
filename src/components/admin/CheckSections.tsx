        ...
        <div className="space-y-4">
          {records.map((record, index) => (
            ...
            >
              ...
              <p className="text-sm text-stone-800 dark:text-stone-300">{record.description}</p>
              {record.details && (
                <details className="mt-3">
                  <summary className="cursor-pointer font-medium text-sm text-stone-800 dark:text-stone-300">
                    View full details
                  </summary>
