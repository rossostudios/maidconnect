...
export function ChangelogEditor({ initialData, changelogId, mode }: ChangelogEditorProps) {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      {error && (
        <div className="mb-6 rounded-2xl border border-stone-300 bg-stone-100 p-4 text-sm text-stone-800 dark:border-red-800 dark:bg-red-950 dark:text-stone-300">
          {error}
        </div>
      )}
      ...
      <form className="space-y-6">
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-950">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                className="w-full rounded-xl border border-stone-200 bg-white px-4 py-3 font-mono text-sm text-stone-600 focus:border-stone-900 focus:outline-none focus:ring-2 focus:ring-stone-500/20 dark:border-stone-100 dark:border-stone-800 dark:bg-stone-950 dark:text-stone-400 dark:focus:ring-stone-400/20"
                id="slug"
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-950">
          <div className="mb-4 flex items-center justify-between">
            ...
            <button
              className="flex items-center gap-2 rounded-lg border border-stone-200 px-3 py-1.5 text-sm text-stone-600 transition hover:border-stone-900 dark:border-stone-100 dark:border-stone-800 dark:text-stone-400"
          ...
          {showPreview ? (
            ...
            <textarea
              className="w-full rounded-xl border border-stone-200 px-4 py-3 font-mono text-sm text-stone-800 focus:border-stone-900 focus:outline-none focus:ring-2 focus:ring-stone-500/20 dark:border-stone-100 dark:border-stone-800 dark:text-stone-300 dark:focus:ring-stone-400/20"
              id="content"
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-950">
          ...
          <div className="space-y-4">
            ...
            {/* Target Audience */}
            <div>
              <div className="mb-2 block font-medium text-sm text-stone-800 dark:text-stone-300">
                Target Audience
              </div>
