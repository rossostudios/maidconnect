...
export function CityHeroSection({
  ...
  return (
    <section
      className={`relative overflow-hidden bg-gradient-to-br from-red-600/5 via-white to-red-600/5 ${className}`}
    >
      {/* Background Pattern */}
      <div
        aria-hidden="true"
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-6 inline-flex w-fit items-center gap-2 rounded-full border border-[#ebe5d8] bg-white px-4 py-2 shadow-sm">
              <HugeiconsIcon className="h-4 w-4 text-[#E85D48]" icon={Location01Icon} />
              <span className="font-medium text-gray-900 text-sm">{cityName}</span>
            </div>

            {/* H1 - Critical for SEO (includes city name + primary keyword) */}
            <h1 className="type-serif-lg mb-6 text-gray-900">
              {t("hero.title", { city: cityName })}
            </h1>

            {/* First 100 words critical for local SEO */}
            <p className="mb-8 text-gray-600 text-lg leading-relaxed sm:text-xl">
            ...
            <div className="mb-8 flex flex-wrap gap-6">
              <div className="flex items-center gap-2">
                <HugeiconsIcon className="h-5 w-5 text-[#E85D48]" icon={UserGroupIcon} />
              ...
              <div className="flex items-center gap-2">
                <HugeiconsIcon className="h-5 w-5 fill-red-600 text-[#E85D48]" icon={StarIcon} />
                <span className="font-semibold text-base text-gray-900">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link
                className="group inline-flex items-center justify-center gap-2 rounded-full bg-[#E85D48] px-8 py-4 font-semibold text-base text-white shadow-[0_4px_12px_rgba(255,93,70,0.22)] transition hover:bg-[#D64A36]"
              ...
              <Link
                className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#ebe5d8] px-8 py-4 font-semibold text-base text-gray-900 transition hover:border-[#E85D48] hover:text-[#E85D48]"
                href="/how-it-works"
              >
          ...
          <div className="relative lg:flex lg:items-center">
            {/* Hero Image */}
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-600/10 to-red-600/5 p-12 shadow-xl">
              {/* Placeholder for city-specific imagery */}
              <div className="relative aspect-square">
                <div className="flex h-full flex-col items-center justify-center gap-6">
                  <HugeiconsIcon className="h-24 w-24 text-[#E85D48]" icon={Location01Icon} />
                  <div className="text-center">
                    <p className="font-bold text-2xl text-gray-900">{cityName}</p>
                    <p className="mt-2 text-base text-gray-600">{t("hero.visualTagline")}</p>
                  </div>
                </div>
              </div>

              {/* Decorative Elements */}
              <div className="absolute top-8 right-8 h-32 w-32 rounded-full bg-[#E85D48]/10 blur-3xl" />
              <div className="absolute bottom-8 left-8 h-32 w-32 rounded-full bg-[#E85D48]/10 blur-3xl" />
            </div>
