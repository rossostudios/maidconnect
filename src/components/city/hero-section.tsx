...
export function CityHeroSection({
  ...
  return (
    <section
      className={`relative overflow-hidden bg-gradient-to-br from-[neutral-500]/5 via-[neutral-50] to-[neutral-500]/5 ${className}`}
    >
      {/* Background Pattern */}
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h1 className="type-serif-lg mb-6 text-[neutral-900]">
              {t("hero.title", { city: cityName })}
            </h1>

            {/* First 100 words critical for local SEO */}
            <p className="mb-8 text-[neutral-400] text-lg leading-relaxed sm:text-xl">
            ...
            <div className="mb-8 flex flex-wrap gap-6">
              <div className="flex items-center gap-2">
                <HugeiconsIcon className="h-5 w-5 text-[neutral-500]" icon={UserGroupIcon} />
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[neutral-500]/10 to-[neutral-500]/5 p-12 shadow-xl">
              ...
              <div className="relative aspect-square">
                <div className="flex h-full flex-col items-center justify-center gap-6">
                  <HugeiconsIcon className="h-24 w-24 text-[neutral-500]" icon={Location01Icon} />
                  <div className="text-center">
                    <p className="font-bold text-2xl text-[neutral-900]">{cityName}</p>
                    <p className="mt-2 text-[neutral-400] text-base">{t("hero.visualTagline")}</p>
                  </div>
                </div>
              </div>
