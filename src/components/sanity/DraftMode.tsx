...
export function DraftModeIndicator() {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 z-50 flex items-center justify-between bg-[#64748b] px-4 py-2 text-[#f8fafc] shadow-lg">
      <div className="flex items-center gap-2">
        <div className="h-2 w-2 animate-pulse rounded-full bg-[#f8fafc]" />
        <span className="font-medium text-sm">Draft Mode Active - Viewing unpublished content</span>
      </div>
      <button
        className="flex items-center gap-2 rounded-md bg-[#f8fafc]/20 px-3 py-1 text-sm transition-colors hover:bg-[#f8fafc]/30"
