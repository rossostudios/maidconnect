      ...
      <div className="mx-auto max-w-[1400px] px-6 sm:px-8">
        ...
        <div className="mb-16 flex flex-col items-start justify-between gap-8 sm:flex-row sm:items-end">
          <div className="max-w-xl space-y-4">
            ...
            <h2 className="font-semibold text-3xl text-neutral-900 tracking-tight sm:text-4xl">
              Latest Arrivals
            </h2>
        ...
        >
          {professionals.map((pro) => (
            <Link
              ...
              key={pro.id}
            >
              <Card className="overflow-hidden border-neutral-200 bg-white transition-all duration-300 group-hover:shadow-lg">
                {/* Image */}
                ...
                <CardContent className="space-y-1 p-4">
                  <h3 className="font-semibold text-base text-neutral-900">{pro.name}</h3>
                  <p className="text-neutral-600 text-sm">
                    {pro.city}, {pro.country}
                  </p>
                  <p className="font-semibold text-neutral-900 text-sm">€{pro.hourlyRate}/hr</p>
                </CardContent>
              </Card>
            </Link>
          ))}
