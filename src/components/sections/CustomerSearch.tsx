...
export function CustomerSearchSection({ professionals }: CustomerSearchSectionProps) {
  ...
  return (
    <section className="border-neutral-200 border-t bg-neutral-50 py-20 sm:py-24">
      <Container className="space-y-12">
        <div className="max-w-3xl space-y-5">
          <h2 className="font-semibold text-3xl text-neutral-900 tracking-tight">
            ...
            {featuredProfessionals.map((professional) => (
              ...
              >
                ...
                <CardContent className="flex flex-1 flex-col gap-3 p-6">
                  ...
                  <p className="text-neutral-600 text-sm">{professional.location}</p>
                  <p className="text-neutral-600 text-sm">
                    {professional.bio
