    ...
    <section className="border-stone-200 border-t bg-stone-50 py-20 sm:py-24">
      <Container className="space-y-12">
            ...
            {featuredProfessionals.map((professional) => (
              <Card
                className={cn(
                  ...
                  "hover:-transtone-y-1 hover:border-stone-400 hover:shadow-lg"
                )}
                key={professional.id}
              >
                ...
                <CardContent className="flex flex-1 flex-col gap-3 p-6">
                  ...
                  <p className="text-sm text-stone-600">{professional.location}</p>
                  <p className="text-sm text-stone-600">
                    {professional.bio
                  ...
                  <div className="mt-auto flex items-center justify-between text-sm text-stone-600">
                    ...
                    <Link
                      className="font-semibold text-sm text-stone-900 underline-offset-4 transition hover:underline"
        ...
        <Card className="rounded-3xl border-stone-200 bg-stone-50/90">
          <CardContent className="flex flex-col gap-4 p-6 text-sm text-stone-600 sm:flex-row sm:items-center sm:justify-between">
            <div>
