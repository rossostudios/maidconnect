...
export async function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 py-4 shadow-sm backdrop-blur-sm">
      <Container className="flex items-center justify-between gap-8 text-slate-900">
