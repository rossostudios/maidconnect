...
export async function DirectHireSection() {
  const t = await getTranslations("directHire");

  return (
    <section className="bg-neutral-900 py-20 sm:py-24 lg:py-32" id="direct-hire">
      <Container>
