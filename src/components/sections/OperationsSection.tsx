...
export function OperationsSection() {
  return (
    <section className="py-16 sm:py-20 lg:py-24">
      <Container>
        <Card className="rounded-[40px] border-neutral-200 bg-neutral-50 p-10 shadow-lg md:p-14">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_minmax(0,_1.1fr)]">
            <div className="flex flex-col gap-5">
              ...
              <Card className="rounded-3xl border-neutral-200 bg-white px-5 py-4 text-sm shadow-sm">
