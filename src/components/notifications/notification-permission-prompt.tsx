...
export function NotificationPermissionPrompt({
  ...
  if (variant === "banner") {
    return (
      <div className="border-[#E5E5E5] border-b bg-[var(--red)]/5 px-6 py-4">
  ...
  return (
    <div className="rounded-xl border border-[#E5E5E5] bg-white p-8 shadow-[0_10px_40px_rgba(18,17,15,0.04)]">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <button
                className="inline-flex items-center justify-center rounded-full border-2 border-[#E5E5E5] bg-white px-6 py-3 font-semibold text-[var(--foreground)] text-base transition hover:border-[var(--red)] hover:text-[var(--red)]"
                onClick={handleDismiss}
                type="button"
              >
                Maybe Later
        ...
        <button
          aria-label="Dismiss"
          className="rounded-full p-2 text-[var(--muted-foreground)] transition hover:bg-[#F5F5F5] hover:text-[var(--foreground)]"
          onClick={handleDismiss}
          type="button"
        >
          <HugeiconsIcon className="h-5 w-5" icon={Cancel01Icon} />
