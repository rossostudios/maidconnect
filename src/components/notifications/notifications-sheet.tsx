...
export function NotificationsSheet({ isOpen, onClose }: Props) {
  ...
  return (
    <>
      ...
      {/* Sheet */}
      <div className="fixed top-0 right-0 z-50 flex h-full w-full max-w-md flex-col bg-[neutral-50] shadow-2xl">
        {/* Header */}
        ...
        <div className="flex items-center justify-between border-[neutral-200] border-b px-6 py-3">
          ...
          {unreadCount > 0 && (
            <button
              className="font-medium text-[neutral-500] text-xs transition hover:text-[neutral-500]"
            ...
            if (notifications.length === 0) {
              return (
                <div className="flex flex-col items-center justify-center p-12">
                  ...
                  <p className="mt-1 text-center text-[neutral-400] text-sm">
                    {filter === "unread"
            ...
            return (
              <div className="divide-y divide-[neutral-200]">
                {notifications.map((notification) => (
                  <div
                    className={`p-4 transition hover:bg-[neutral-50] ${
                      notification.read_at ? "" : "bg-[neutral-500]/5"
                    }`}
                    key={notification.id}
                  >
                    {notification.url ? (
