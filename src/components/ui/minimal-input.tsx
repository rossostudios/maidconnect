...
export function MinimalInput({ label, error, helper, className, ...props }: MinimalInputProps) {
  return (
    <div className="w-full">
      ...
      <input
        className={cn(
          "flex h-9 w-full border border-neutral-200 bg-white px-3 py-2 text-neutral-900 text-sm transition-colors file:border-0 file:bg-transparent file:font-medium file:text-sm placeholder:text-neutral-600 focus-visible:border-neutral-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400/20 disabled:cursor-not-allowed disabled:opacity-50",
...
export function MinimalTextarea({
  ...
  return (
    <div className="w-full">
      ...
      <textarea
        className={cn(
          "flex w-full border border-neutral-200 bg-white px-3 py-2 text-neutral-900 text-sm transition-colors placeholder:text-neutral-600 focus-visible:border-neutral-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400/20 disabled:cursor-not-allowed disabled:opacity-50",
          error && "border-red-300 focus-visible:border-red-400 focus-visible:ring-red-400/20",
          className
        )}
        rows={rows}
