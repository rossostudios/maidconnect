    ...
    <div className="relative" ref={containerRef}>
      ...
      >
        <span className="flex items-center gap-2">
          <HugeiconsIcon aria-hidden="true" className="h-4 w-4 text-[#64748b]" icon={Clock01Icon} />
      ...
      {open ? (
        <div className="absolute z-50 mt-3 max-h-64 w-full min-w-[220px] overflow-y-auto rounded-3xl border border-[#e2e8f0] bg-[#f8fafc] p-2 shadow-[0_24px_60px_rgba(22,22,22,0.12)]">
              ...
              return (
                <button
                  className={cn(
                    ...
                    isSelected
                      ? "bg-[#0f172a] text-[#f8fafc] shadow-[0_12px_32px_rgba(22,22,22,0.16)]"
                ...
                >
                  ...
                  {isSelected ? (
                    <span className="text-[#94a3b8] text-xs uppercase tracking-[0.2em]">
                      Selected
                    </span>
                  ) : null}
                </button>
