...
export function TimePicker({
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {open ? (
        <div className="absolute z-50 mt-3 max-h-64 w-full min-w-[220px] overflow-y-auto border border-[neutral-200] bg-[neutral-50] p-2 shadow-[0_24px_60px_rgba(22,22,22,0.12)]">
