  ...
  return (
    ...
    >
      <div className="grid overflow-visible rounded-[32px] md:grid-cols-[minmax(220px,1fr)_minmax(220px,1fr)_minmax(280px,1.3fr)_auto]">
        ...
        {/* Search Button */}
        <Button
          className="rounded-r-[32px] bg-stone-500 px-12 py-6 font-semibold text-stone-50 text-sm uppercase tracking-[0.15em] hover:bg-stone-500 active:scale-[0.98] md:min-w-[180px]"
          type="submit"
        >
          {t("searchButton")}
        </Button>
