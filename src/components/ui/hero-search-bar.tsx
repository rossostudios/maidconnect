    ...
    >
      <div className="grid grid-cols-1 gap-2 overflow-visible p-4 md:grid-cols-[1fr_1fr_1fr_auto]">
        ...
        <div className="group relative flex flex-col items-start gap-1">
          <label className="font-semibold text-neutral-500 text-xs uppercase tracking-wider">
            {t("where")}
          </label>
          <Select onValueChange={setLocation} value={location}>
            <SelectTrigger className="w-full appearance-none border-0 bg-transparent p-0 text-base text-neutral-900 shadow-none focus:outline-none focus:ring-0">
        ...
        {/* Date Input */}
        <div className="group relative z-20 flex flex-col items-start gap-1 border-neutral-200 border-y py-3 md:border-y-0 md:border-l md:py-0 md:pl-4">
          <label className="font-semibold text-neutral-500 text-xs uppercase tracking-wider">
            {t("when")}
          </label>
        ...
        {/* Service Type */}
        <div className="group relative flex flex-col items-start gap-1 border-neutral-200 border-b pb-3 md:border-b-0 md:border-l md:pb-0 md:pl-4">
          <label className="font-semibold text-neutral-500 text-xs uppercase tracking-wider">
            {t("service")}
          </label>
