  ...
  return (
    ...
    >
      ...
      <div className={cn("mt-4 flex flex-col", CARD_LAYOUT.sectionGap)}>
        ...
        <div className="flex items-baseline gap-3">
          ...
          {trend && (
            <span
              className={cn(
                "font-medium text-sm",
                trend.direction === "up" && "text-stone-700 dark:text-emerald-400",
                trend.direction === "down" && "text-stone-800 dark:text-red-400",
        ...
        {/* Description */}
        {description && <p className="text-sm text-stone-600 dark:text-stone-400">{description}</p>}
