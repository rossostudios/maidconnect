...
export function TwoColumnFeature({
  ...
  const bgColor = backgroundColor === "cream" ? "bg-stone-50" : "bg-white";
      ...
      <Container>
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className={cn("space-y-6", contentOrder)}>
            {tagline && <p className="tagline text-stone-600">{tagline}</p>}

            <h2 className="serif-display-lg text-stone-900">{heading}</h2>

            <p className="lead text-stone-900/70">{description}</p>
