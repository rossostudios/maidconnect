...
// Simpler schema for direct hire requests
...
type DirectHireFormData = z.infer<typeof directHireSchema>;

export function DirectHireForm() {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<DirectHireFormData>({
    resolver: zodResolver(directHireSchema),
  });

  const onSubmit = async (data: DirectHireFormData) => {
    ...
    try {
      ...
      console.error("Error submitting direct hire request:", error);
    ...
    return (
      ...
      >
        <div className="rounded-lg border border-neutral-200 bg-white p-12 shadow-lg">
          ...
          <h2 className="mb-4 font-[family-name:var(--font-geist-sans)] font-bold text-3xl text-neutral-900">
            Request Received!
          </h2>
          <p className="mb-8 text-lg text-neutral-600 leading-relaxed">
            ...
            out within 2 hours during business hours (Mon-Fri, 9am-6pm COT). {commissionPercentage}{" "}
            placement commission on agreed salary with legal contracts and ongoing support.
          </p>
    ...
    <>
      ...
      <div className="mb-16 text-center">
        ...
        <p className="mx-auto max-w-3xl text-lg text-neutral-600 leading-relaxed">
          20% service fee (paid by the customer). Our team handles matching, legal contracts, and a
      ...
      <div className="mb-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-lg border border-neutral-200 bg-white p-6 shadow-md transition-all duration-200 hover:shadow-lg">
          ...
          <h3 className="mb-2 font-[family-name:var(--font-geist-sans)] font-semibold text-neutral-900">
            Personal Coordinator
          </h3>
          <p className="text-neutral-600 text-sm leading-relaxed">
            Dedicated bilingual coordinator who understands your needs and manages your entire
            search.
          </p>
        </div>
            ...
            <thead className="border-neutral-200 border-b bg-neutral-50">
              <tr>
                ...
                <th className="p-4 text-center font-semibold text-neutral-700">
                  Instant Book
                  <div className="mt-1 font-normal text-neutral-700 text-xs">
                    15% fee on hourly jobs
                  </div>
                </th>
                <th className="p-4 text-center font-semibold text-orange-600">
                  Direct Hire
                  <div className="mt-1 font-normal text-orange-500 text-xs">
                    20% service fee (customer pays)
                  </div>
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-neutral-200">
              ...
              <tr>
                ...
                <td className="p-4 text-center text-neutral-600 text-sm">
                  One-time jobs, recurring tasks, hourly help
                </td>
      ...
      <div className="rounded-lg border border-neutral-200 bg-white p-8 shadow-lg sm:p-12">
        <div className="mb-8 text-center">
          <h2 className="mb-2 font-[family-name:var(--font-geist-sans)] font-bold text-3xl text-neutral-900">
            Request Direct Hire Service
          </h2>
          <p className="text-neutral-600 leading-relaxed">
            Fill out this short form and we'll respond within 2 hours (during business hours). 20%
            service fee (customer pays) for placements.
          </p>
        </div>
        ...
        <form className="mx-auto max-w-xl space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="pt-4">
            <Button
              className="w-full font-[family-name:var(--font-geist-sans)] font-semibold shadow-md transition-all duration-200 hover:shadow-lg"
