...
const createCategories = (unreadMessagesCount = 0): CategorySection[] => [
  {
    id: "overview",
    icon: Home09Icon,
    label: "Overview",
    ...
    items: [
      { href: "/dashboard/customer", label: "Dashboard", description: "Overview & stats" },
      { href: "/dashboard/customer/bookings", label: "Bookings", description: "Your appointments" },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/dashboard/customer/recurring-plans",
...
/**
 * LiaCustomerDoubleSidebar - Lia Design System
 *
 * Context-aware double sidebar for customer dashboard:
 ...
 */
export function LiaCustomerDoubleSidebar({
  userEmail,
  userName,
  userAvatarUrl,
  ...
  const categories = useMemo(() => createCategories(unreadMessagesCount), [unreadMessagesCount]);
