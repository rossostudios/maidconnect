...
import { useAddressesAndAddons } from "@/hooks/useAddresses";
import { useBookingSubmission } from "@/hooks/useBooking";
import { useFeatureFlag } from "@/hooks/useFeature";
import { trackEvent } from "@/lib/analytics/trackEvent";
import { formatCurrencyCOP, normalizeServiceName } from "@/lib/bookingUtils";
...
function ServiceDetailsStep({
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <div className="mb-2 block font-medium text-sm text-stone-900">Select Date & Time *</div>
        <div className="rounded-lg border-2 border-stone-200 bg-white p-4">
          <p className="text-sm text-stone-500">Calendar integration coming soon</p>
        </div>
