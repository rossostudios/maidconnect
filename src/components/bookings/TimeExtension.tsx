...
export function TimeExtensionModal({
  ...
  return (
    ...
    >
      ...
      {/* Error Message */}
      {form.error && (
        <div className="mb-4 rounded-lg border border-neutral-300 bg-neutral-100 p-3 text-neutral-800 text-sm dark:border-red-800 dark:bg-red-950 dark:text-neutral-300">
          {form.error}
        </div>
      )}
