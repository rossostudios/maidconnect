...
export function RebookButton({ booking }: RebookButtonProps) {
  ...
  return (
    <>
      <button
        className="inline-flex w-full items-center justify-center gap-2 bg-rausch-500 px-5 py-2.5 font-semibold text-sm text-white shadow-sm transition hover:bg-rausch-600 active:bg-rausch-700"
