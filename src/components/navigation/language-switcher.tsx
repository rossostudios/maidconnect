  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className="relative inline-flex rounded-lg border border-neutral-200 bg-white p-1 dark:border-rausch-700 dark:bg-rausch-900"
        role="group"
      >
        {/* Sliding orange background indicator */}
        <div
        ...
        <button
          ...
          className={`relative z-10 px-4 py-1.5 font-[family-name:var(--font-geist-sans)] font-semibold text-xs uppercase tracking-wider transition-colors duration-300 ${
            locale === "en"
              ? "text-white"
              : "text-neutral-600 hover:text-neutral-900 dark:text-rausch-400 dark:hover:text-white"
          }`}
