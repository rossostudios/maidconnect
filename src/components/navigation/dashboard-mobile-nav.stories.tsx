  ...
  decorators: [
    (Story) => (
      <div className="min-h-screen bg-slate-50 pb-20">
        <div className="p-4">
          <h1 className="font-bold text-2xl text-slate-900">Customer Dashboard</h1>
          <p className="mt-2 text-slate-600">Mobile navigation at bottom</p>
        </div>
        <Story />
      </div>
    ),
...
export const ProfessionalView: Story = {
  ...
  decorators: [
    (Story) => (
      <div className="min-h-screen bg-slate-50 pb-20">
        <div className="p-4">
          <h1 className="font-bold text-2xl text-slate-900">Professional Dashboard</h1>
          <p className="mt-2 text-slate-600">Notice "Jobs" instead of "Bookings"</p>
        </div>
        <Story />
      </div>
    ),
    ...
    (Story) => (
      <div className="min-h-screen bg-slate-50 pb-20">
        <div className="p-4">
          ...
          <p className="mt-2 text-slate-600">With unread badges on Messages and Alerts</p>
        </div>
        <Story />
      </div>
    ),
...
export const ActiveBookings: Story = {
  ...
  decorators: [
    (Story) => (
      <div className="min-h-screen bg-slate-50 pb-20">
        <div className="p-4">
          <h1 className="font-bold text-2xl text-slate-900">My Bookings</h1>
          <p className="mt-2 text-slate-600">Bookings tab is active</p>
        </div>
        <Story />
      </div>
    ),
