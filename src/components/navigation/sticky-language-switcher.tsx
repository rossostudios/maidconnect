    ...
    <div className="fixed top-4 right-4 z-50 md:top-6 md:right-6">
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-2 rounded-full border-2 border-stone-200 bg-white px-4 py-2 font-medium text-stone-900 text-sm shadow-md transition hover:border-stone-300 hover:shadow-lg"
            ...
            <div className="absolute top-full right-0 z-50 mt-2 w-48 overflow-hidden rounded-2xl border-2 border-stone-200 bg-white shadow-xl">
              {languages.map((lang) => (
                ...
                >
                  ...
                  <span className="text-stone-900 text-sm">{lang.name}</span>
