...
const ProductBottomSheetWrapper = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <header className="border-slate-200 border-b bg-white p-4">
        <div className="flex items-center justify-between">
          <div className="font-bold text-slate-900 text-xl">Casaora</div>
          <button
            className="rounded-lg border border-slate-300 bg-white px-4 py-2 font-medium text-slate-900 text-sm transition hover:bg-slate-50"
      ...
      <div className="p-4">
        <h1 className="font-bold text-2xl text-slate-900">Product Features</h1>
        <p className="mt-2 text-slate-600">Click the button to open the bottom sheet</p>
      </div>
      <ProductBottomSheet
  ...
  render: () => {
    ...
    return (
      <div className="min-h-screen bg-slate-50">
        <header className="border-slate-200 border-b bg-white p-4">
          <button
            className="rounded-lg bg-slate-900 px-4 py-2 font-semibold text-sm text-white transition hover:bg-slate-800"
            onClick={() => setIsOpen(true)}
            type="button"
          >
            View 3 Features
