  ...
  return (
    <section className="bg-white py-20 sm:py-24 lg:py-32" id="positions">
      <Container className="max-w-5xl">
        <h2 className="font-semibold text-4xl text-[#211f1a] sm:text-5xl">{t("title")}</h2>
        ...
        <div className="mt-16 space-y-16">
          {categories.map((categoryKey) => {
            ...
            return (
              <div key={categoryKey}>
                {/* Category Title */}
                <h3 className="mb-6 font-semibold text-2xl text-[#211f1a]">{categoryTitle}</h3>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-[#211f1a] text-xl">{jobTitle}</h4>
        ...
        <div className="mt-16 rounded-[28px] bg-[#fbfaf9] p-8 text-center sm:p-12">
          <h3 className="font-semibold text-2xl text-[#211f1a] sm:text-3xl">
            Don't see a perfect match?
          </h3>
          <p className="mt-4 text-[#5d574b] text-lg leading-relaxed">
