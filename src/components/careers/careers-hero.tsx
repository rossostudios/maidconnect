      ...
      <Container className="max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <h1 className="type-serif-display mt-6 text-gray-900">{t("title")}</h1>
            <p className="mt-6 text-gray-600 text-xl leading-relaxed sm:text-2xl">
              {t("description")}
            </p>
            <div className="mt-12">
          ...
          <div className="relative">
            <div className="aspect-[4/3] overflow-hidden rounded-[28px] bg-gradient-to-br from-red-600/10 to-red-600/5 shadow-[0_20px_60px_rgba(18,17,15,0.08)]">
              {/* Placeholder for team image */}
              <div className="flex h-full w-full items-center justify-center">
                <div className="text-center text-[#7d7566]">
                  <svg
                    aria-hidden="true"
                    className="mx-auto h-24 w-24 text-[#E85D48]/20"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
