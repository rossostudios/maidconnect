        ...
        >
          ...
          <div className="px-6 pt-16 pb-8">
            <Tabs defaultValue="language">
              {/* Tab Navigation */}
              <TabsList className="h-auto w-full justify-start gap-6 border-neutral-200 border-b bg-transparent p-0 dark:border-border">
                <TabsTrigger
                  className={cn(
                    "rounded-t-lg bg-transparent px-4 pt-2 pb-4 shadow-none",
                    "data-[selected]:border-neutral-900 data-[selected]:border-b-2 dark:data-[selected]:border-foreground",
                    "data-[selected]:bg-transparent data-[selected]:text-neutral-900 dark:data-[selected]:text-foreground",
                    "text-neutral-500 hover:text-neutral-900 dark:text-muted-foreground dark:hover:text-foreground",
              ...
              <TabsContent className="mt-8" value="language">
                {/* Translation Toggle */}
                <div className="flex items-center justify-between border-neutral-100 border-b py-4 dark:border-border">
                  <div className="flex items-center gap-3">
                    <HugeiconsIcon
                      className="h-6 w-6 text-neutral-700 dark:text-foreground"
                    ...
                    <div>
                      ...
                      <p className="text-neutral-500 text-sm dark:text-muted-foreground">
                    ...
                    {LANGUAGES.map((lang) => (
                      <button
                        className={cn(
                          ...
                          "hover:border-neutral-300 dark:hover:border-rausch-500",
                          ...
                          locale === lang.code
                            ? "border-neutral-900 bg-neutral-50 dark:border-white dark:bg-muted"
                      ...
                      >
                        ...
                        <span className="text-neutral-500 text-sm dark:text-muted-foreground">
                          {lang.region}
                        </span>
                      </button>
                    ))}
                ...
                <div className="mt-8">
                  ...
                  <p className="mb-4 text-neutral-500 text-sm dark:text-muted-foreground">
              ...
              <TabsContent className="mt-8" value="currency">
                ...
                <p className="mb-6 text-neutral-500 text-sm dark:text-muted-foreground">
