  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="font-semibold text-sm text-stone-900">Booking Frequency</h3>
        <button
          className="text-stone-700 text-xs hover:text-stone-900"
        ...
        {tiers.map((tier) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="font-semibold text-stone-900">{getTierDescription(tier)}</h4>
                  </div>
                  {discountLabel && (
                    <p className="mt-1 font-semibold text-stone-700 text-xs">💰 {discountLabel}</p>
                  )}
                </div>
              </div>
              ...
              {tier !== "none" && (
                <Card className="mt-3 border-stone-200 bg-white">
      ...
      {showDetails && selectedTier !== "none" && (
        <Card className="border-stone-200 bg-stone-50">
          <CardContent className="p-4">
            ...
            <Card className="mt-4 border-stone-200 bg-white">
              <CardContent className="p-3 text-stone-600 text-xs">
                <p className="font-semibold text-stone-900">Flexible cancellation</p>
                <p className="mt-1">
