      ...
      <Container className="max-w-5xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <div
                className="group rounded-xl border-2 border-neutral-200 bg-neutral-50 p-6 transition-all duration-200 hover:border-orange-500 hover:bg-orange-50"
                key={feature.key}
              >
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full border-2 border-neutral-200 bg-white transition-all group-hover:border-orange-500 group-hover:bg-orange-50">
                  <HugeiconsIcon
        ...
        {/* Trust Badge */}
        <div className="mt-12 rounded-xl border-2 border-orange-200 bg-orange-50 p-8 text-center">
