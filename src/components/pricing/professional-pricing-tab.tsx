          ...
          {howItWorksSteps.map((step) => {
            ...
            return (
              <motion.div className="text-center" key={step.key} variants={fadeInUp}>
                <motion.div
                  className="mb-4 inline-flex h-20 w-20 items-center justify-center rounded-full border-4 border-orange-500 bg-orange-100"
              ...
              <motion.div key={benefit.key} variants={fadeInUp}>
                <Card className="h-full border-2 border-neutral-200 bg-white transition-all duration-200 hover:border-orange-500 hover:shadow-lg">
                  <CardContent className="p-6 text-center">
                    <motion.div
                      className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-orange-100"
                ...
                <motion.div key={idx} variants={fadeInUp}>
                  <Card className="h-full border-2 border-orange-200 bg-white">
                    <CardContent className="p-6">
                      <motion.div
                        className="mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-orange-500"
