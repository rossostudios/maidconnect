            ...
            {trend.map((point, index) => {
              ...
              return (
                <div className="group relative flex flex-1 flex-col items-center" key={index}>
                  ...
                  {/* Tooltip on hover */}
                  <div className="-top-16 -transtone-x-1/2 pointer-events-none absolute left-1/2 z-10 hidden rounded-lg bg-[#0f172a] px-3 py-2 text-[#f8fafc] text-xs shadow-lg group-hover:block">
                    ...
                    <div className="-bottom-1 -transtone-x-1/2 absolute left-1/2 h-2 w-2 rotate-45 bg-[#0f172a]" />
                  </div>
