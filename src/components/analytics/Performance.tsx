    ...
    <div className="rounded-lg border bg-white p-6 shadow-sm ring-1 ring-black/5">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-lg bg-stone-50 p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="font-medium text-sm text-stone-600">{t("completionRate")}</span>
          </div>
        ...
        <div className="rounded-lg bg-stone-50 p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="font-medium text-sm text-stone-600">{t("averageRating")}</span>
          </div>
        ...
        <div className="rounded-lg bg-stone-50 p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="font-medium text-sm text-stone-600">{t("totalRevenue")}</span>
          </div>
        ...
        <div className="rounded-lg bg-stone-50 p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="font-medium text-sm text-stone-600">{t("cancellationRate")}</span>
          </div>
          <p className="font-bold text-3xl text-stone-500">
      ...
      <div className="mt-6 grid gap-3 border-stone-200 border-t pt-4">
        <div className="flex items-center justify-between">
          <span className="text-sm text-stone-500">{t("averageBookingValue")}</span>
          <span className="font-semibold text-stone-900">
            {formatCurrency(metrics.averageBookingValueCop)}
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-sm text-stone-500">{t("repeatCustomerRate")}</span>
          <span className="font-semibold text-stone-900">
            {metrics.repeatCustomerRate.toFixed(1)}%
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-sm text-stone-500">{t("onTimeArrivalRate")}</span>
          <span className="font-semibold text-stone-900">
            {metrics.onTimeArrivalRate.toFixed(1)}%
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-sm text-stone-500">{t("averageResponseTime")}</span>
          <span className="font-semibold text-stone-900">
