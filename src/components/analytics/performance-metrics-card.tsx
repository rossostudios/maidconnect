...
export function PerformanceMetricsCard({ metrics }: PerformanceMetricsCardProps) {
  ...
  return (
    <div className="rounded-lg border bg-white p-6 shadow-sm ring-1 ring-black/5">
      {/* Header */}
      <div className="mb-6">
        <h3 className="font-semibold text-lg text-slate-900">{t("title")}</h3>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-lg bg-slate-50 p-4">
          <div className="mb-2 flex items-center gap-2">
            <HugeiconsIcon className="h-5 w-5 text-slate-500" icon={CheckmarkCircle02Icon} />
            <span className="font-medium text-slate-600 text-sm">{t("completionRate")}</span>
          </div>
        ...
        <div className="rounded-lg bg-slate-50 p-4">
          <div className="mb-2 flex items-center gap-2">
            <HugeiconsIcon className="h-5 w-5 text-slate-500" icon={StarIcon} />
            <span className="font-medium text-slate-600 text-sm">{t("averageRating")}</span>
          </div>
        ...
        <div className="rounded-lg bg-slate-50 p-4">
          <div className="mb-2 flex items-center gap-2">
            <HugeiconsIcon className="h-5 w-5 text-slate-500" icon={MoneyBag02Icon} />
            <span className="font-medium text-slate-600 text-sm">{t("totalRevenue")}</span>
          </div>
        ...
        <div className="rounded-lg bg-slate-50 p-4">
          <div className="mb-2 flex items-center gap-2">
            <HugeiconsIcon className="h-5 w-5 text-slate-500" icon={CancelCircleIcon} />
            <span className="font-medium text-slate-600 text-sm">{t("cancellationRate")}</span>
          </div>
          <p className="font-bold text-3xl text-slate-500">
      ...
      {/* Additional Metrics */}
      <div className="mt-6 grid gap-3 border-slate-200 border-t pt-4">
        <div className="flex items-center justify-between">
          <span className="text-slate-500 text-sm">{t("averageBookingValue")}</span>
          <span className="font-semibold text-slate-900">
            {formatCurrency(metrics.averageBookingValueCop)}
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-slate-500 text-sm">{t("repeatCustomerRate")}</span>
          <span className="font-semibold text-slate-900">
            {metrics.repeatCustomerRate.toFixed(1)}%
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-slate-500 text-sm">{t("onTimeArrivalRate")}</span>
          <span className="font-semibold text-slate-900">
            {metrics.onTimeArrivalRate.toFixed(1)}%
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-slate-500 text-sm">{t("averageResponseTime")}</span>
          <span className="font-semibold text-slate-900">
