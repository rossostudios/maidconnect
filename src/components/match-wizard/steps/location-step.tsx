    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#211f1a]/5">
          <MapPin className="h-8 w-8 text-[#211f1a]" />
        </div>
      </div>
      ...
      <div className="space-y-4">
        {/* City Selection */}
        <div>
          <label className="mb-2 block font-medium text-[#211f1a] text-sm" htmlFor="city">
        ...
        {data.city && neighborhoods.length > 0 && (
          <div>
            <label className="mb-2 block font-medium text-[#211f1a] text-sm" htmlFor="neighborhood">
