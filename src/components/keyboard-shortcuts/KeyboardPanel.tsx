      ...
      >
        ...
        <div className="h-[calc(100%-180px)] overflow-y-auto px-6 py-6">
          {filteredShortcuts.length === 0 ? (
            <div className="py-12 text-center text-[neutral-400] text-sm">No shortcuts found.</div>
          ) : (
            <div className="space-y-8 pb-4">
              {categories.map((category) => {
                ...
                return (
                  <div key={category}>
                    <h3 className="mb-4 font-semibold text-[neutral-400] text-xs uppercase tracking-wider">
