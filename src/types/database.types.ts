  ...
  public: {
    Tables: {
      ...
      balance_audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "balance_audit_log_booking_id_fkey";
            columns: ["booking_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "balance_audit_log_payout_transfer_id_fkey";
            columns: ["payout_transfer_id"];
            isOneToOne: false;
            referencedRelation: "payout_transfers";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "balance_audit_log_professional_id_fkey";
            columns: ["professional_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
      ...
      balance_clearance_queue: {
        ...
        Relationships: [
          {
            foreignKeyName: "balance_clearance_queue_booking_id_fkey";
            columns: ["booking_id"];
            isOneToOne: true;
            referencedRelation: "bookings";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "balance_clearance_queue_professional_id_fkey";
            columns: ["professional_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
      ...
      bookings: {
        Row: {
          ...
          trial_credit_applied_cents: number;
          updated_at: string;
        };
        Insert: {
          address?: string | null;
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "bookings_country_code_fkey";
      ...
      currencies: {
        ...
        Relationships: [
          {
            foreignKeyName: "currencies_country_code_fkey";
            columns: ["country_code"];
            isOneToOne: false;
            referencedRelation: "countries";
            referencedColumns: ["code"];
      ...
      moderation_flags: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "moderation_flags_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
      ...
      payout_batches: {
        ...
        Relationships: [
          {
            foreignKeyName: "payout_batches_country_code_fkey";
            columns: ["country_code"];
            isOneToOne: false;
            referencedRelation: "countries";
            referencedColumns: ["code"];
      ...
      payout_rate_limits: {
        Row: {
          created_at: string | null;
          id: string;
          instant_payout_count: number | null;
        ...
        Relationships: [
          {
            foreignKeyName: "payout_rate_limits_professional_id_fkey";
            columns: ["professional_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
      ...
      payout_transfers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "payout_transfers_country_code_fkey";
            columns: ["country_code"];
            isOneToOne: false;
            referencedRelation: "countries";
            referencedColumns: ["code"];
      ...
      pricing_controls: {
        Row: {
          background_check_fee_cents: number | null;
          city: string | null;
      ...
      professional_performance_metrics: {
        Row: {
          ...
          revenue_last_7_days_cents: number | null;
      ...
      professional_profiles: {
        Row: {
          ...
          country_code: string;
          created_at: string;
          direct_hire_fee_cents: number;
          earnings_last_updated_at: string | null;
          emergency_contact: Json | null;
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "professional_profiles_country_code_fkey";
            columns: ["country_code"];
            isOneToOne: false;
            referencedRelation: "countries";
            referencedColumns: ["code"];
      ...
      trial_credits: {
        Row: {
          created_at: string;
          credit_applied_to_booking_id: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: "trial_credits_credit_applied_to_booking_id_fkey";
            columns: ["credit_applied_to_booking_id"];
            isOneToOne: false;
            referencedRelation: "bookings";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "trial_credits_customer_id_fkey";
            columns: ["customer_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "trial_credits_last_booking_id_fkey";
          ...
          {
            foreignKeyName: "trial_credits_professional_id_fkey";
            columns: ["professional_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      add_to_pending_balance: {
        Args: { p_amount_cop: number; p_professional_id: string };
        Returns: undefined;
      };
      ...
      check_instant_payout_rate_limit: {
        Args: { p_max_daily_limit?: number; p_professional_id: string };
        Returns: boolean;
      };
      ...
      generate_professional_slug: {
        Args: { p_full_name: string; p_profile_id: string };
        Returns: string;
      };
      ...
      get_moderation_stats: {
        Args: never;
        Returns: {
          auto_detected_flags: number;
          critical_flags: number;
          pending_flags: number;
          total_flags: number;
        }[];
      };
      get_neighborhoods_by_city: {
      ...
      get_trial_credit_info: {
        Args: { p_customer_id: string; p_professional_id: string };
        Returns: {
          bookings_completed: number;
          credit_available_cop: number;
          credit_available_usd: number;
          has_credit: boolean;
          max_credit_cop: number;
          percentage_earned: number;
          total_bookings_value_cop: number;
        }[];
      };
      ...
      increment_professional_stats: {
        Args: { p_earnings_cop: number; p_professional_id: string };
        Returns: undefined;
      };
