...
console.log(`     ✅ Product pages (6): ${Object.keys(en.pages).filter(k =>
  ['bookingPlatform', 'professionalProfiles', 'paymentProcessing',
   'secureMessaging', 'reviewsRatings', 'adminDashboard'].includes(k)
).join(', ')}`);
console.log(`     ✅ Static pages (6): ${Object.keys(en.pages).filter(k =>
