    ...
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">🏠 Trusted Home Services</h1>
          <p className="text-gray-600">Interactive Wireframes & User Flows</p>
        </div>
            ...
            {Object.entries(flows).map(([key, flow]) => (
              <button
                ...
                className={`p-4 rounded-lg border-2 transition-all ${
                  activeFlow === key
                    ? `${flow.color} text-white border-transparent`
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              {/* Screen Header */}
              <div className={`${currentFlow.color} text-white p-4`}>
              ...
              <div className="p-8 bg-gray-50 flex justify-center">
                <div className="w-full max-w-md">
                  {/* Phone mockup */}
                  <div className="bg-white rounded-3xl shadow-2xl border-8 border-gray-800 overflow-hidden">
                    {/* Phone notch */}
    ...
    <div className="p-4">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600">Trusted professionals near you</p>
        </div>
      ...
      <div className="mb-6">
        <div className="relative">
          <input
            ...
            className="w-full p-4 pr-12 border-2 border-gray-300 rounded-lg focus:border-blue-500"
          />
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          {['Cleaning', 'Cooking', 'Laundry', 'Ironing', 'Organization', 'Deep Clean'].map(service => (
            <button key={service} className="p-3 bg-blue-50 rounded-lg text-center hover:bg-blue-100">
      ...
      <div>
        ...
        <div className="space-y-3">
          {[1, 2].map(i => (
            <div key={i} className="border-2 border-gray-200 rounded-lg p-3 hover:border-blue-500 cursor-pointer">
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-600">Cleaning • Cooking</div>
                </div>
                <div className="text-right">
                  <div className="font-bold text-blue-600">$25/hr</div>
                </div>
              </div>
            </div>
          ))}
    ...
    <div className="p-4">
      ...
      <div className="flex items-center mb-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-600">24 professionals found</p>
        </div>
      </div>
      ...
      <div className="flex gap-2 mb-4 overflow-x-auto pb-2">
        ...
        <button className="px-4 py-2 bg-gray-100 rounded-full text-sm whitespace-nowrap">Top Rated</button>
        <button className="px-4 py-2 bg-gray-100 rounded-full text-sm whitespace-nowrap">Available Today</button>
        <button className="px-4 py-2 bg-gray-100 rounded-full text-sm whitespace-nowrap">Price: Low-High</button>
      </div>

      {/* Results */}
      <div className="space-y-3">
        {[1, 2, 3, 4].map(i => (
          <div key={i} className="border-2 border-gray-200 rounded-lg p-4 hover:border-blue-500 cursor-pointer">
            <div className="flex">
              <div className="w-20 h-20 bg-gray-300 rounded-lg mr-3 flex-shrink-0"></div>
              <div className="flex-1">
                <div className="flex items-start justify-between mb-1">
                  <div>
                    <div className="font-bold">Ana Silva {i === 1 && <span className="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full ml-1">Top Pro</span>}</div>
                ...
                <div className="flex gap-1">
                  <span className="text-xs bg-blue-50 text-blue-700 px-2 py-1 rounded">Cleaning</span>
                  <span className="text-xs bg-blue-50 text-blue-700 px-2 py-1 rounded">English</span>
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="pb-20">
      ...
      <div className="relative h-48 bg-gradient-to-br from-blue-400 to-purple-500">
        <button className="absolute top-4 left-4 w-10 h-10 bg-white rounded-full flex items-center justify-center">←</button>
      </div>
      ...
      <div className="px-4 -mt-16">
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 mb-4">
          <div className="flex items-start mb-3">
            <div className="w-24 h-24 bg-gray-300 rounded-full mr-4 border-4 border-white"></div>
            <div className="flex-1">
              <div className="flex items-center mb-1">
                <h2 className="text-xl font-bold mr-2">Maria Rodriguez</h2>
                <span className="bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full">Top Pro</span>
              </div>
              ...
              <div className="flex gap-2 text-xs">
                <span className="bg-green-100 text-green-700 px-2 py-1 rounded">Available Today</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            {[1, 2].map(i => (
              <div key={i} className="border-b pb-3">
                ...
                <p className="text-sm text-gray-700">Excellent service! Very professional and thorough. Highly recommend.</p>
              </div>
            ))}
          </div>
        </div>
    ...
    <div className="p-4 pb-24">
      ...
      <div className="bg-blue-50 rounded-lg p-3 mb-6">
        <div className="flex items-center">
          ...
          <div>
            <div className="font-semibold">Maria Rodriguez</div>
            <div className="text-sm text-gray-600">House Cleaning • $25/hr</div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2">
          {['2 hrs', '3 hrs', '4 hrs', '5 hrs'].map(duration => (
            <button key={duration} className="flex-1 p-3 border-2 border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50">
              {duration}
            </button>
          ))}
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="border-2 border-gray-300 rounded-lg p-3 flex items-center">
      ...
      <div className="bg-gray-50 rounded-lg p-4 mb-6">
        ...
        <div className="border-t pt-2 flex justify-between text-lg font-bold">
          <span>Total</span>
          <span className="text-blue-600">$88.50</span>
        </div>
      </div>
...
function BookingConfirmationScreen() {
  return (
    <div className="p-4 flex flex-col items-center justify-center min-h-full">
      ...
      <p className="text-gray-600 text-center mb-8">Maria has been notified and will confirm within 24 hours</p>

      {/* Booking Details Card */}
      <div className="w-full bg-white border-2 border-gray-200 rounded-xl p-4 mb-6">
      ...
      <div className="w-full space-y-3">
        ...
        <button className="w-full bg-white border-2 border-gray-300 py-3 rounded-lg font-semibold flex items-center justify-center">
          <MessageSquare size={18} className="mr-2" />
          Message Maria
        </button>
        <button className="w-full bg-white border-2 border-gray-300 py-3 rounded-lg font-semibold">
          Add to Calendar
        </button>
      </div>

      <div className="mt-8 text-center">
        <p className="text-sm text-gray-500">You'll receive reminders 24h and 2h before</p>
      </div>
    </div>
  );
}
    ...
    <div className="p-4">
      ...
      <div className="bg-blue-100 border-2 border-blue-500 rounded-lg p-4 mb-4">
        <div className="flex items-center">
          ...
          <div>
            <div className="font-bold text-blue-900">New Booking Request!</div>
            <div className="text-sm text-blue-700">Respond within 24 hours</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-4 mb-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="text-blue-600 text-sm font-semibold">View Full Profile</button>
        </div>
        ...
        <div className="flex items-center mb-3">
          ...
          <div>
            ...
            <div className="flex items-center mt-1">
              ...
              <span className="text-xs text-green-700 font-semibold">ID Verified</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">~2.3 km away</div>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <div className="font-bold text-lg text-green-600">$75.00</div>
              <div className="text-xs text-gray-500">(Platform takes $13.50)</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-4 mb-4">
        ...
        <p className="text-sm text-gray-700">"Please use eco-friendly products. I have a cat. Access code is #1234."</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <button className="w-full bg-white text-red-600 border-2 border-red-300 py-3 rounded-lg font-semibold">
          Decline
        </button>
      </div>
        ...
        <div className="space-y-3">
          {[1, 2].map(i => (
            <div key={i} className="border-b pb-3">
              ...
              <p className="text-sm text-gray-700">Very respectful and clear with instructions. Home was clean and well-maintained. Would work for again!</p>
            </div>
          ))}
        </div>
      </div>
...
function AcceptBookingScreen() {
  return (
    <div className="p-4 flex flex-col items-center justify-center min-h-full">
      ...
      <p className="text-gray-600 text-center mb-8">John has been notified. Details added to your calendar.</p>
      ...
      <div className="w-full bg-white border-2 border-gray-200 rounded-xl p-4 mb-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm font-semibold text-green-600">You earn: $75.00</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-3 w-full">
  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">Check in to begin your service</p>
      </div>
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-4">
        <div className="flex items-center">
          ...
          <div>
            <div className="font-bold">John Martinez</div>
            <div className="text-sm text-gray-600">House Cleaning • 3 hours</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-4 mb-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">Expected Earnings:</span>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-6">
        ...
        <p className="text-sm text-gray-700">Use eco-friendly products. Cat in house. Access code: #1234</p>
      </div>

      {/* Check-in Button */}
      <button className="w-full bg-blue-600 text-white py-4 rounded-lg font-bold text-lg mb-3">
  ...
  return (
    <div className="p-4 pb-24">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">Finish and rate your customer</p>
      </div>
      ...
      <div className="bg-green-50 border-2 border-green-200 rounded-lg p-4 mb-4">
        <div className="text-center mb-3">
          ...
          <div className="text-4xl font-bold text-green-700">3h 05m</div>
        </div>
        <div className="flex justify-between text-sm">
          <span className="text-gray-600">Check-in: 9:00 AM</span>
          <span className="text-gray-600">Now: 12:05 PM</span>
        </div>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-4 mb-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <button className="aspect-square border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center hover:border-blue-500">
        ...
        <div className="space-y-3">
          {['Respectfulness', 'Communication', 'Property Condition', 'Payment Promptness'].map(category => (
            <div key={category}>
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map(star => (
                  <button key={star} className="w-10 h-10 border-2 border-gray-300 rounded-lg hover:border-yellow-400 hover:bg-yellow-50">
      ...
      {/* Earnings Summary */}
      <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-20">
        <div className="flex justify-between mb-2">
        ...
        <div className="border-t pt-2 flex justify-between text-lg font-bold">
          ...
          <span className="text-green-600">$63.14</span>
        </div>
  ...
  return (
    <div className="p-4 pb-24">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Start your journey as a trusted professional</p>
      </div>

      <div className="space-y-4">
        <div>
          <label className="font-semibold text-sm mb-1 block">Full Name</label>
          <input type="text" className="w-full p-3 border-2 border-gray-300 rounded-lg" placeholder="Maria Rodriguez" />
        </div>

        <div>
          <label className="font-semibold text-sm mb-1 block">ID Number</label>
          <input type="text" className="w-full p-3 border-2 border-gray-300 rounded-lg" placeholder="Cédula de Ciudadanía" />
        </div>

        <div>
          <label className="font-semibold text-sm mb-1 block">Phone Number</label>
          <input type="tel" className="w-full p-3 border-2 border-gray-300 rounded-lg" placeholder="+57 300 123 4567" />
        </div>

        <div>
          <label className="font-semibold text-sm mb-1 block">Email</label>
          <input type="email" className="w-full p-3 border-2 border-gray-300 rounded-lg" placeholder="maria@email.com" />
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {['Cleaning', 'Cooking', 'Laundry', 'Ironing', 'Organization', 'Deep Clean'].map(service => (
              <label key={service} className="flex items-center p-2 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-blue-500">
        ...
        <div>
          ...
          <input type="number" className="w-full p-3 border-2 border-gray-300 rounded-lg" placeholder="25" />
        </div>

        <div>
          <label className="font-semibold text-sm mb-1 block">Reference 1 - Name & Phone</label>
          <input type="text" className="w-full p-3 border-2 border-gray-300 rounded-lg mb-2" placeholder="Name" />
          <input type="tel" className="w-full p-3 border-2 border-gray-300 rounded-lg" placeholder="Phone" />
        </div>
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <div className="text-sm text-gray-600">Cédula or Passport</div>
            </div>
            <span className="text-red-600 text-sm font-semibold">Required</span>
          </div>
          <button className="w-full border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-blue-500">
            <Camera size={32} className="text-gray-400 mx-auto mb-2" />
            <div className="text-sm text-gray-600">Tap to upload or take photo</div>
          </button>
        </div>
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <div className="text-sm text-gray-600">Utility bill or lease</div>
            </div>
            <span className="text-red-600 text-sm font-semibold">Required</span>
          </div>
          <button className="w-full border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-blue-500">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <div className="text-sm text-gray-600">Professional certificates (if any)</div>
            </div>
            <span className="text-gray-500 text-sm font-semibold">Optional</span>
          </div>
          <button className="w-full border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-blue-500">
            <Camera size={32} className="text-gray-400 mx-auto mb-2" />
            <div className="text-sm text-gray-600">Tap to upload</div>
          </button>
        </div>
      </div>
  ...
  return (
    <div className="p-4">
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-center">Schedule your in-person interview</p>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        <div className="flex items-start">
          <MapPin size={20} className="text-gray-600 mr-2 mt-1" />
          <div>
            <div className="font-semibold">Interview Location</div>
            <div className="text-sm text-gray-600">Calle 72 #10-51, Oficina 302</div>
            <div className="text-sm text-gray-600">Chapinero, Bogotá</div>
            <button className="text-blue-600 text-sm font-semibold mt-1">Get Directions</button>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="p-4 pb-24">
      <div className="mb-6">
        ...
        <p className="text-gray-600">This is how customers will see you</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-2">Professional photo from your interview will be used</p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={item.service} className="flex items-center gap-2">
                ...
                <input
                  type="number"
                  className="w-20 p-2 border-2 border-gray-300 rounded text-sm"
                  placeholder="25"
                />
          ...
          <p className="text-xs text-gray-500 mt-2">Suggested rates shown. You can set your own.</p>
        </div>
          ...
          <div className="space-y-2">
            {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'].map(day => (
              <div key={day} className="flex items-center gap-2">
                ...
                <input type="time" className="p-2 border-2 border-gray-300 rounded text-sm" defaultValue="08:00" />
                <span className="text-sm">to</span>
                <input type="time" className="p-2 border-2 border-gray-300 rounded text-sm" defaultValue="17:00" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-500">List neighborhoods you're willing to work in</p>
        </div>
      </div>
...
function ProfileLiveScreen() {
  return (
    <div className="p-4 flex flex-col items-center justify-center min-h-full">
      ...
      <p className="text-gray-600 text-center mb-8">Your profile is now live and customers can find you</p>
...
function ServiceCompleteScreen() {
  return (
    <div className="p-4 flex flex-col items-center justify-center min-h-full">
      ...
      <p className="text-gray-600 text-center mb-8">Maria has finished the cleaning service</p>
    ...
    <div className="p-4 pb-24">
          ...
          <div key={category.name}>
            ...
            <div className="flex gap-2">
              {[1, 2, 3, 4, 5].map(star => (
                <button
                  key={star}
                  className="w-12 h-12 border-2 border-gray-300 rounded-lg hover:border-yellow-400 hover:bg-yellow-50 flex items-center justify-center"
                >
      ...
      <div className="bg-gray-50 rounded-lg p-4 mb-6 text-center">
        ...
        <div className="flex justify-center mt-2">
          {[1, 2, 3, 4, 5].map(star => (
            <Star key={star} size={20} className={star <= 4 ? "text-yellow-400 fill-yellow-400" : "text-gray-300"} />
          ))}
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        ></textarea>
        <div className="text-xs text-gray-500 text-right">0 / 500 characters</div>
      </div>
...
function AddTipScreen() {
  return (
    <div className="p-4 flex flex-col items-center justify-center min-h-full">
      ...
      <p className="text-gray-600 text-center mb-8">Would you like to add a tip for Maria?</p>

      {/* Professional Card */}
      <div className="w-full bg-white border-2 border-gray-200 rounded-lg p-4 mb-6">
        <div className="flex items-center">
          <div className="w-16 h-16 bg-gray-300 rounded-full mr-3"></div>
          <div>
            <div className="font-bold">Maria Rodriguez</div>
            <div className="flex items-center">
              ...
              <span className="text-gray-600 text-sm ml-1">(your rating)</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full mb-6">
        <div className="grid grid-cols-3 gap-3 mb-4">
          {['10%', '15%', '20%'].map(percent => (
            <button
              key={percent}
              className="p-4 border-2 border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50"
            >
        ...
        <div className="border-2 border-gray-300 rounded-lg p-4">
          <label className="text-sm text-gray-600 block mb-2">Custom Amount</label>
          <div className="flex items-center">
...
function PaymentConfirmedScreen() {
  return (
    <div className="p-4 flex flex-col items-center justify-center min-h-full">
      ...
      <p className="text-gray-600 text-center mb-8">Payment processed successfully</p>

      {/* Receipt Card */}
      <div className="w-full bg-white border-2 border-gray-200 rounded-xl p-6 mb-6">
        <div className="text-center mb-4">
          <div className="text-sm text-gray-600 mb-1">Receipt #12345</div>
          <div className="text-xs text-gray-500">Nov 5, 2025 • 12:15 PM</div>
        </div>

        <div className="border-t border-b py-4 space-y-2 mb-4">
          <div className="flex justify-between text-sm">
            <span className="text-gray-600">Service (3.08 hrs × $25)</span>
            <span>$77.00</span>
          </div>
          <div className="flex justify-between text-sm">
        ...
        <div className="flex justify-between text-lg font-bold">
          ...
          <span className="text-blue-600">$104.14</span>
        </div>
      ...
      {/* Thank You Message */}
      <div className="w-full bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-4">
