-- Sprint 1: Professional Experience Enhancement - FIXED
-- This migration combines all Sprint 1 features with CORRECT column names
-- Fixed: user_type → role (profiles table uses 'role' column)
