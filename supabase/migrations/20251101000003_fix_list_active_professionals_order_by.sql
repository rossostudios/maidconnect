-- Fix ambiguous rating reference in list_active_professionals ORDER BY clause
-- The issue: ORDER BY references 'rating' which is ambiguous with reviews.rating
...
begin
  ...
  select
    ...
    -- Rating calculation (aliased to avoid ambiguity)
    coalesce(
  ...
  -- Use explicit column positions to avoid ambiguity
