-- =============================================
-- Etta AI Chat System Database Schema (Fixed)
-- =============================================
...
CREATE INDEX IF NOT EXISTS idx_etta_conversations_user_id ON public.etta_conversations(user_id);
CREATE INDEX IF NOT EXISTS idx_etta_conversations_active ON public.etta_conversations(user_id, is_active) WHERE is_active = true;
CREATE INDEX IF NOT EXISTS idx_etta_conversations_last_message ON public.etta_conversations(user_id, last_message_at DESC);

-- Performance indexes for etta_messages
CREATE INDEX IF NOT EXISTS idx_etta_messages_conversation_id ON public.etta_messages(conversation_id);
CREATE INDEX IF NOT EXISTS idx_etta_messages_created_at ON public.etta_messages(conversation_id, created_at ASC);
CREATE INDEX IF NOT EXISTS idx_etta_messages_role ON public.etta_messages(role);
