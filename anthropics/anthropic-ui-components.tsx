...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "font-heading font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
...
export const Input: React.FC<InputProps> = ({
  ...
  <div className="w-full">
    {label && (
      <label className="mb-1.5 block font-heading font-medium text-[#141413] text-sm">
        {label}
      </label>
    )}
    <input
      className={`w-full rounded-lg border-2 border-[#e8e6dc] bg-[#faf9f5] px-4 py-2 font-body text-[#141413] transition-colors duration-200 placeholder:text-[#b0aea5] focus:border-[#d97757] focus:outline-none focus:ring-2 focus:ring-[#d97757] focus:ring-opacity-20 disabled:cursor-not-allowed disabled:bg-[#e8e6dc] ${error ? "border-red-500 focus:border-red-500 focus:ring-red-500" : ""}
          ${className}
        `}
      {...props}
    />
    {error && <p className="mt-1.5 font-body text-red-600 text-sm">{error}</p>}
    {helperText && !error && (
      <p className="mt-1.5 font-body text-[#b0aea5] text-sm">{helperText}</p>
    )}
  </div>
);
...
export const Textarea: React.FC<TextareaProps> = ({
  ...
  <div className="w-full">
    ...
    <textarea
      className={`resize-vertical w-full rounded-lg border-2 border-[#e8e6dc] bg-[#faf9f5] px-4 py-2 font-body text-[#141413] transition-colors duration-200 placeholder:text-[#b0aea5] focus:border-[#d97757] focus:outline-none focus:ring-2 focus:ring-[#d97757] focus:ring-opacity-20 disabled:cursor-not-allowed disabled:bg-[#e8e6dc] ${error ? "border-red-500 focus:border-red-500 focus:ring-red-500" : ""}
          ${className}
        `}
      {...props}
    />
...
export const Badge: React.FC<BadgeProps> = ({ children, variant = "orange", className = "" }) => {
  ...
  return (
    <span
      className={`inline-flex items-center rounded-full px-3 py-1 font-heading font-medium text-xs ${variants[variant]} ${className}`}
    >
      {children}
    </span>
  );
...
export const Alert: React.FC<AlertProps> = ({ children, variant = "info", className = "" }) => {
  ...
  return (
    <div className={`rounded-lg border-l-4 p-4 font-body ${variants[variant]} ${className}`}>
      {children}
    </div>
  );
};
...
export const Toggle: React.FC<ToggleProps> = ({ checked, onChange, label, disabled = false }) => (
  <label className="flex cursor-pointer items-center">
    ...
    {label && <span className="ml-3 font-body text-[#141413]">{label}</span>}
  </label>
);
...
export const Select: React.FC<SelectProps> = ({
  ...
  <div className="w-full">
    ...
    <select
      className={`w-full rounded-lg border-2 border-[#e8e6dc] bg-[#faf9f5] px-4 py-2 font-body text-[#141413] transition-colors duration-200 focus:border-[#d97757] focus:outline-none focus:ring-2 focus:ring-[#d97757] focus:ring-opacity-20 disabled:cursor-not-allowed disabled:bg-[#e8e6dc] ${error ? "border-red-500 focus:border-red-500 focus:ring-red-500" : ""}
          ${className}
        `}
      {...props}
    >
...
export const Checkbox: React.FC<CheckboxProps> = ({ label, className = "", ...props }) => (
  <label className="flex cursor-pointer items-center">
    <input
      ...
      {...props}
    />
    {label && <span className="ml-2 font-body text-[#141413]">{label}</span>}
  </label>
);
...
export const ComponentShowcase = () => {
  ...
  return (
    <div className="space-y-8 bg-[#faf9f5] p-8">
      {/* Buttons */}
      <section>
        <h2 className="mb-4 font-heading text-2xl text-[#141413]">Buttons</h2>
      ...
      {/* Inputs */}
      <section>
        <h2 className="mb-4 font-heading text-2xl text-[#141413]">Form Inputs</h2>
      ...
      {/* Cards */}
      <section>
        <h2 className="mb-4 font-heading text-2xl text-[#141413]">Cards</h2>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <Card variant="default">
            <h3 className="mb-2 font-heading text-lg">Default Card</h3>
            <p className="font-body text-[#b0aea5]">With subtle border</p>
          </Card>
          <Card variant="elevated">
            <h3 className="mb-2 font-heading text-lg">Elevated Card</h3>
            <p className="font-body text-[#b0aea5]">With shadow</p>
          </Card>
          <Card variant="bordered">
            <h3 className="mb-2 font-heading text-lg">Bordered Card</h3>
      ...
      {/* Badges */}
      <section>
        <h2 className="mb-4 font-heading text-2xl text-[#141413]">Badges</h2>
      ...
      {/* Alerts */}
      <section>
        <h2 className="mb-4 font-heading text-2xl text-[#141413]">Alerts</h2>
      ...
      {/* Toggle */}
      <section>
        <h2 className="mb-4 font-heading text-2xl text-[#141413]">Toggle</h2>
