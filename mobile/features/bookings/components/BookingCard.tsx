  ...
  return (
    <Pressable onPress={handlePress} style={styles.container}>
      ...
      <View style={styles.row}>
        <IconSymbol color="#1E293B" name="calendar" size={18} />
        <Text style={styles.rowText}>{formatDateRange(booking.startsAt, booking.endsAt)}</Text>
      </View>

      {booking.professionalName ? (
        <View style={styles.row}>
          <IconSymbol color="#1E293B" name="person.crop.circle.badge.checkmark" size={18} />
      ...
      {booking.customerName ? (
        <View style={styles.row}>
          <IconSymbol color="#1E293B" name="person.crop.circle" size={18} />
      ...
      {booking.addressSummary ? (
        <View style={styles.row}>
          <IconSymbol color="#1E293B" name="mappin.circle" size={18} />
      ...
      <View style={styles.footer}>
        {booking.durationMinutes ? (
          <View style={styles.footerPill}>
            <IconSymbol color="#1E3A8A" name="clock" size={16} />
        ...
        {totalAmountLabel ? (
          <View style={styles.footerPill}>
            <IconSymbol color="#1E3A8A" name="creditcard" size={16} />
